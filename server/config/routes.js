...
const protectedStaticDirServer =
  (prefix, getPathSegment) => (req, res, next) => {
    if (!req.url.startsWith(prefix)) {
      return next();
    }
...
module.exports.routes = {
  ...
  "POST /api/projects/:projectId/base-custom-field-groups":
    "base-custom-field-groups/create",
  ...
  "POST /api/boards/:boardId/custom-field-groups":
    "custom-field-groups/create-in-board",
  "POST /api/cards/:cardId/custom-field-groups":
    "custom-field-groups/create-in-card",
  ...
  "POST /api/users/:userId/notification-services":
    "notification-services/create-in-user",
  "POST /api/boards/:boardId/notification-services":
    "notification-services/create-in-board",
