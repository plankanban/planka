...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToCreateApiKey: 'Are you sure you want to create an API key for this user?',
      areYouSureYouWantToCycleApiKey:
        'Are you sure you want to cycle (regenerate) the API key for this user? The old key will no longer work.',
      areYouSureYouWantToRemoveApiKey: 'Are you sure you want to remove the API key for this user?',
      ...
      noApiKey: 'No API key',
      apiKeyActions_title: 'API Key Actions',
      createApiKey_title: 'Create API Key',
      cycleApiKey_title: 'Cycle API Key',
      removeApiKey_title: 'Remove API Key',
      apiKeyWarningHeader: 'Important: Copy Your API Key Now',
      apiKeyWarning:
        'This API key will only be shown once. Make sure to copy it now before closing this dialog.',
      apiKeyWillBeDisplayedHere: 'API key will be displayed here after creation.',
      apiKeyInstructions:
        'Copy this API key and store it securely. You will not be able to see it again.',
      apiKeyCopied: 'API key copied to clipboard!',
      copied: 'Copied',
      userDoesNotHaveApiKey: 'User does not have an API key.',
      apiKeyAlreadyExists: 'API key already exists for this user.',
    ...
    action: {
      ...
      showOnlyWithApiKeys: 'Show only users with API keys',
