...
export default {
  ...
  translation: {
    common: {
      ...
      exportData_title: 'Export Data',
      exportProjectFull: 'Export Full Project as JSON',
      exportProjectTemplate: 'Export Project Template as JSON (no Cards)',
      import: 'Import',
      importProject_title: 'Import Project',
