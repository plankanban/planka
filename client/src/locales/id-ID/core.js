...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Tambah layanan notifikasi',
      ...
      autoLogout: 'Keluar otomatis',
      autoLogout_10m: 'Setelah 10 menit',
      autoLogout_12h: 'Setelah 12 jam',
      autoLogout_2m: 'Setelah 2 menit',
      autoLogout_30m: 'Setelah 30 menit',
      autoLogout_5m: 'Setelah 5 menit',
      autoLogout_never: 'Tidak pernah',
      autoLogoutWarning_body: 'Anda akan dikeluarkan dalam {{seconds}} detik karena tidak aktif.',
      autoLogoutWarning_title: 'Anda akan segera dikeluarkan',
      ...
      color: 'Warna',
      comments: 'Komentar',
      confirmCodesSaved: 'Saya telah menyimpan kode-kode ini di tempat yang aman.',
      ...
      disable2fa_title: 'Nonaktifkan autentikasi dua faktor',
      disable2faWarning:
        'Anda perlu mengonfirmasi kata sandi Anda saat ini dan kode TOTP. Sesi yang sudah ada akan tetap masuk.',
      enable2fa_title: 'Aktifkan autentikasi dua faktor',
      enabledOn: 'Diaktifkan pada {{date}}',
      enterCodeFromApp: 'Masukkan kode 6 digit dari aplikasi autentikator Anda.',
      enterPasswordToContinue: 'Konfirmasi kata sandi Anda saat ini untuk melanjutkan.',
      ...
      never: 'Tidak pernah',
      noTrustedDevices: 'Tidak ada perangkat tepercaya.',
      orEnterSecretManually: 'Atau masukkan kunci rahasia ini secara manual:',
      recoveryCodesExhausted:
        'Semua kode pemulihan telah digunakan. Buat ulang sekumpulan kode baru agar Anda tetap memiliki cadangan jika kehilangan aplikasi autentikator Anda.',
      recoveryCodesIntro:
        'Simpan kode-kode ini di tempat yang aman — masing-masing dapat digunakan satu kali jika Anda kehilangan akses ke aplikasi autentikator Anda.',
      recoveryCodesLow_other:
        'Hanya tersisa {{count}} kode pemulihan. Sebaiknya segera buat ulang.',
      regenerateRecoveryCodes_title: 'Buat ulang kode pemulihan',
      regenerateRecoveryCodesIntro:
        'Membuat kode baru akan membatalkan semua kode pemulihan yang ada.',
      reset2fa_title: 'Setel ulang 2FA',
      reset2faWarning:
        'Menyetel ulang 2FA akan mengeluarkan pengguna dari semua sesi dan menghapus pengaturan TOTP mereka. Mereka harus mengaturnya kembali saat masuk berikutnya.',
      saveTheseCodes_title: 'Simpan kode pemulihan ini',
      scanQrCodeWithApp:
        'Pindai kode QR ini dengan aplikasi autentikator seperti Google Authenticator atau Authy.',
      security_title: 'Keamanan',
      totpCode: 'Kode TOTP',
      totpOrRecoveryCode: 'Kode TOTP atau kode pemulihan',
      trustedDevices_title: 'Peramban tepercaya',
      trustedDevicesHint:
        'Peramban yang telah ditandai sebagai tepercaya akan melewati faktor kedua selama 30 hari. Cabut semua yang sudah tidak Anda kenali.',
      twoFactor_enabled: 'Autentikasi dua faktor telah diaktifkan.',
      twoFactor_intro:
        'Tambahkan lapisan keamanan ekstra ke akun Anda menggunakan kode sekali pakai berbasis waktu dari aplikasi autentikator.',
      ...
      openBoardActions: 'Buka aksi papan',
      openBoard_title: 'Buka papan',
      openCardActions: 'Buka aksi kartu',
      openListActions: 'Buka aksi daftar',
      openNotifications: 'Buka notifikasi',
      openProjectActions: 'Buka aksi proyek',
      openProjectSettings: 'Buka setelan proyek',
      ...
      private: 'Pribadi',
      proFeatureDashboard: '✨ Satu dasbor untuk semua proyek',
      proFeatureExport: '✨ Kartu sebagai PDF untuk laporan Anda',
      proFeatureMobile: '✨ PLANKA di ponsel dan tablet',
      proFeatureSso: '✨ Masuk dengan direktori perusahaan Anda (SSO)',
      proFeatureThemes: '✨ Lima tema dan warna aksen Anda sendiri',
      proFeatureTimeline: '✨ Timeline: satu tahun penuh dalam satu sumbu',
      proTrialSelfHosted: '✨ Coba PLANKA Pro selama 30 hari di server Anda sendiri',
      project: 'Proyek',
      ...
      showHiddenProjects: 'Tampilkan proyek tersembunyi',
    ...
    action: {
      ...
      filterByCurrentUser: 'Saring berdasarkan pengguna saat ini',
      goBack: 'Kembali',
      hideHiddenProjects: 'Sembunyikan proyek tersembunyi',
      hideProjectList: 'Sembunyikan daftar proyek',
      import: 'Impor',
      join: 'Bergabung',
      leave: 'Keluar',
      ...
      showProjectList: 'Tampilkan daftar proyek',
      sortList_title: 'Urutkan daftar',
      start: 'Mulai',
      stayLoggedIn: 'Tetap masuk',
      stop: 'Berhenti',
      subscribe: 'Berlanggan',
      switchToGridProjectsView: 'Tampilkan proyek sebagai kisi',
      switchToGridView: 'Beralih ke tampilan kisi',
      switchToGroupedProjectsView: 'Tampilkan proyek secara berkelompok',
      switchToKanbanView: 'Beralih ke tampilan kanban',
