...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Adaugă serviciu de notificare',
      ...
      autoLogout_10m: 'După 10 minute',
      autoLogout_12h: 'După 12 ore',
      autoLogout_2m: 'După 2 minute',
      autoLogout_30m: 'După 30 de minute',
      autoLogout_5m: 'După 5 minute',
      autoLogout_never: 'Niciodată',
      autoLogoutWarning_body: 'Veți fi deconectat în {{seconds}}s din cauza inactivității.',
      autoLogoutWarning_title: 'Veți fi deconectat în curând',
      background: 'Fundal',
      ...
      color: 'Culoarea',
      comments: 'Comentarii',
      confirmCodesSaved: 'Am salvat aceste coduri într-un loc sigur.',
      ...
      proFeatureDashboard: '✨ Un singur tablou de bord pentru toate proiectele',
      proFeatureExport: '✨ Carduri în format PDF pentru rapoartele tale',
      proFeatureMobile: '✨ PLANKA pe telefon și tabletă',
      proFeatureSso: '✨ Autentificare cu directorul companiei tale (SSO)',
      proFeatureThemes: '✨ Cinci teme și propria ta culoare de accent',
      proFeatureTimeline: '✨ Cronologie: un an întreg pe o singură axă',
      proTrialSelfHosted: '✨ Încearcă PLANKA Pro 30 de zile pe serverul tău',
      ...
      disable2fa_title: 'Dezactivează autentificarea cu doi factori',
      disable2faWarning:
        'Va trebui să confirmați parola curentă și un cod TOTP. Sesiunile existente rămân conectate.',
      enable2fa_title: 'Activează autentificarea cu doi factori',
      enabledOn: 'Activată la {{date}}',
      enterCodeFromApp: 'Introduceți codul din 6 cifre din aplicația de autentificare.',
      enterPasswordToContinue: 'Confirmați parola curentă pentru a continua.',
      enterTotpOrRecoveryCode:
        'Introduceți codul din 6 cifre din aplicația de autentificare sau unul dintre codurile de recuperare (xxxxx-xxxxx).',
      expires: 'Expiră',
      invalidTotpCode: 'Cod TOTP sau de recuperare nevalid',
      lastUsed: 'Ultima utilizare',
      never: 'Niciodată',
      noTrustedDevices: 'Niciun dispozitiv de încredere.',
      openBoardActions: 'Deschide acțiunile tablei',
      openCardActions: 'Deschide acțiunile cardului',
      openListActions: 'Deschide acțiunile listei',
      openNotifications: 'Deschide notificările',
      openProjectActions: 'Deschide acțiunile proiectului',
      openProjectSettings: 'Deschide setările proiectului',
      orEnterSecretManually: 'Sau introduceți manual acest secret:',
      recoveryCodesExhausted:
        'Toate codurile de recuperare au fost utilizate. Generați un set nou pentru a păstra o alternativă în cazul în care pierdeți accesul la aplicația de autentificare.',
      recoveryCodesIntro:
        'Păstrați aceste coduri într-un loc sigur — fiecare poate fi utilizat o singură dată dacă pierdeți accesul la aplicația de autentificare.',
      recoveryCodesLow_one:
        'A mai rămas doar {{count}} cod de recuperare. Vă recomandăm să regenerați codurile în curând.',
      recoveryCodesLow_few:
        'Au mai rămas doar {{count}} coduri de recuperare. Vă recomandăm să regenerați codurile în curând.',
      recoveryCodesLow_other:
        'Au mai rămas doar {{count}} de coduri de recuperare. Vă recomandăm să regenerați codurile în curând.',
      regenerateRecoveryCodes_title: 'Regenerează codurile de recuperare',
      regenerateRecoveryCodesIntro:
        'Generarea unor coduri noi va invalida toate codurile de recuperare existente.',
      reset2fa_title: 'Resetează 2FA',
      reset2faWarning:
        'Resetarea 2FA deconectează utilizatorul din toate sesiunile și îi elimină configurarea TOTP. Va trebui să o configureze din nou la următoarea autentificare.',
      saveTheseCodes_title: 'Salvează aceste coduri de recuperare',
      scanQrCodeWithApp:
        'Scanați acest cod QR cu o aplicație de autentificare precum Google Authenticator sau Authy.',
      security_title: 'Securitate',
      showHiddenProjects: 'Afișează proiectele ascunse',
      totpCode: 'Cod TOTP',
      totpOrRecoveryCode: 'Cod TOTP sau de recuperare',
      trustedDevices_title: 'Browsere de încredere',
      trustedDevicesHint:
        'Browserele marcate ca fiind de încredere omit al doilea factor timp de 30 de zile. Revocați-le pe cele pe care nu le mai recunoașteți.',
      twoFactor_enabled: 'Autentificarea cu doi factori este activată.',
      twoFactor_intro:
        'Adăugați un nivel suplimentar de securitate contului dumneavoastră folosind un cod unic bazat pe timp dintr-o aplicație de autentificare.',
    ...
    action: {
      ...
      disableEditMode: 'Dezactivează modul de editare',
      ...
      enableEditMode: 'Activează modul de editare',
      filterByCurrentUser: 'Filtrați după utilizatorul curent',
      goBack: 'Înapoi',
      hideHiddenProjects: 'Ascunde proiectele ascunse',
      hideProjectList: 'Ascunde lista de proiecte',
      import: 'Import',
      join: 'Alăturați-vă',
      leave: 'Părăsiți',
      ...
      regenerateRecoveryCodes: 'Regenerează codurile de recuperare',
      remove: 'Eliminați',
      ...
      showProjectList: 'Afișează lista de proiecte',
      sortList_title: 'Sortați lista',
      start: 'Start',
      stayLoggedIn: 'Rămâneți conectat',
      stop: 'Stop',
      subscribe: 'Abonati-va',
      switchToGridProjectsView: 'Afișează proiectele ca grilă',
      switchToGridView: 'Comută la vizualizarea grilă',
      switchToGroupedProjectsView: 'Afișează proiectele grupate',
      switchToKanbanView: 'Comută la vizualizarea kanban',
      switchToListView: 'Comută la vizualizarea listă',
