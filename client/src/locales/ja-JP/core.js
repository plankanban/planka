...
export default {
  ...
  translation: {
    common: {
      ...
      autoLogout: '自動ログアウト',
      autoLogout_10m: '10分後',
      autoLogout_12h: '12時間後',
      autoLogout_2m: '2分後',
      autoLogout_30m: '30分後',
      autoLogout_5m: '5分後',
      autoLogout_never: 'しない',
      autoLogoutWarning_body: '非アクティブ状態のため、{{seconds}}秒後にログアウトします。',
      autoLogoutWarning_title: 'まもなくログアウトします',
      background: '背景',
      ...
      color: '色',
      comments: 'コメント',
      confirmCodesSaved: 'これらのコードを安全な場所に保存しました。',
      ...
      proFeatureDashboard: '✨ すべてのプロジェクトを1つのダッシュボードで',
      proFeatureExport: '✨ レポート用にカードをPDFで出力',
      proFeatureMobile: '✨ スマートフォンとタブレットでPLANKAを利用',
      proFeatureSso: '✨ 社内ディレクトリでログイン(SSO)',
      proFeatureThemes: '✨ 5つのテーマと独自のアクセントカラー',
      proFeatureTimeline: '✨ タイムライン: 1年間を1本の軸で',
      proTrialSelfHosted: '✨ 自分のサーバーでPLANKA Proを30日間お試し',
      dismissProBannerFor30Days: '30日間閉じる',
      customerPanel_title: '顧客パネル',
      dangerZone_title: '危険ゾーン',
      disable2fa_title: '二要素認証を無効にする',
      disable2faWarning:
        '現在のパスワードとTOTPコードの確認が必要です。既存のセッションはログインしたままになります。',
      enable2fa_title: '二要素認証を有効にする',
      enabledOn: '{{date}}に有効化',
      enterCodeFromApp: '認証アプリに表示された6桁のコードを入力してください。',
      enterPasswordToContinue: '続行するには現在のパスワードを確認してください。',
      ...
      lastUsed: '最終使用',
      never: 'なし',
      noTrustedDevices: '信頼済みのデバイスはありません。',
      orEnterSecretManually: 'または、このシークレットを手動で入力してください:',
      recoveryCodesExhausted:
        'すべてのリカバリーコードが使用されました。認証アプリを利用できなくなった場合に備えて、新しいコードを生成してください。',
      recoveryCodesIntro:
        'これらのコードは安全な場所に保管してください。認証アプリにアクセスできなくなった場合、それぞれ1回だけ使用できます。',
      recoveryCodesLow_other:
        '残りのリカバリーコードは{{count}}個です。早めに再生成することをおすすめします。',
      regenerateRecoveryCodes_title: 'リカバリーコードを再生成',
      regenerateRecoveryCodesIntro:
        '新しいコードを生成すると、既存のリカバリーコードはすべて無効になります。',
      reset2fa_title: '2FAをリセット',
      reset2faWarning:
        '2FAをリセットすると、そのユーザーはすべてのセッションからログアウトされ、TOTPの設定が削除されます。次回のログイン時に再度設定する必要があります。',
      saveTheseCodes_title: 'これらのリカバリーコードを保存',
      scanQrCodeWithApp:
        'Google AuthenticatorやAuthyなどの認証アプリでこのQRコードをスキャンしてください。',
      security_title: 'セキュリティ',
      totpCode: 'TOTPコード',
      totpOrRecoveryCode: 'TOTPコードまたはリカバリーコード',
      trustedDevices_title: '信頼済みブラウザー',
      trustedDevicesHint:
        '信頼済みとしてマークされたブラウザーは、30日間二要素認証をスキップします。心当たりのないものは解除してください。',
      twoFactor_enabled: '二要素認証は有効です。',
      twoFactor_intro:
        '認証アプリの時間ベースのワンタイムコードを使用して、アカウントのセキュリティを強化します。',
    ...
    autoLogout: '自動ログアウト',
    autoLogoutWarning_body: '操作がないため、{{seconds}}秒後にログアウトします。',
    autoLogoutWarning_title: 'まもなくログアウトします',
    autoLogout_10m: '10分後',
    autoLogout_12h: '12時間後',
    autoLogout_2m: '2分後',
    ...
    disable2faWarning: '現在のパスワードとTOTPコードの入力が必要です。既存のセッションは維持されます。',
    disable2fa_title: '2要素認証を無効にする',
    done: '完了',
    enable2fa: '2要素認証を有効にする',
    enable2fa_title: '2要素認証を有効にする',
    enabledOn: '{{date}} に有効化されました',
    enterCodeFromApp: '認証アプリの6桁のコードを入力してください。',
    enterPasswordToContinue: '続行するには、現在のパスワードを確認してください。',
    enterTotpOrRecoveryCode: '認証アプリの6桁のコード、またはリカバリーコード（xxxxx-xxxxx）を入力してください。',
    expires: '有効期限',
    invalidTotpCode: 'TOTPまたはリカバリーコードが無効です',
    lastUsed: '最終使用日時',
    logOutNow: 'すぐにログアウト',
    never: 'なし',
    noTrustedDevices: '信頼されたデバイスがありません。',
    orEnterSecretManually: 'または、以下のシークレットを手動で入力してください：',
    recoveryCodesExhausted: 'すべてのリカバリーコードを使用しました。認証アプリを紛失した際のバックアップとして、新しいセットを再生成してください。',
    recoveryCodesIntro: 'これらのコードは安全な場所に保管してください。認証アプリにアクセスできなくなった場合、各コードを一度だけ使用できます。',
    recoveryCodesLow_one: 'リカバリーコードが残り {{count}} 個です。間もなく再生成を検討してください。',
    recoveryCodesLow_other: 'リカバリーコードが残り {{count}} 個です。間もなく再生成を検討してください。',
    regenerate: '再生成',
    regenerateRecoveryCodes: 'リカバリーコードを再生成',
    regenerateRecoveryCodesIntro: '新しいコードを生成すると、既存のすべてのリカバリコードは無効になります。',
    regenerateRecoveryCodes_title: 'リカバリコードの再生成',
    reset2fa: '2要素認証をリセット',
    reset2faWarning: '2FAをリセットすると、すべてのセッションからログアウトされ、TOTPの設定が削除されます。次回ログイン時に再設定が必要になります。',
    reset2fa_title: '2FAのリセット',
    revoke: '無効にする',
    saveTheseCodes_title: 'リカバリコードを保存する',
    scanQrCodeWithApp: 'Google AuthenticatorやAuthyなどの認証アプリで、このQRコードをスキャンしてください。',
    security_title: 'セキュリティ',
    stayLoggedIn: 'ログイン状態を維持する',
    totpCode: 'TOTPコード',
    totpOrRecoveryCode: 'TOTPまたはリカバリコード',
    trustedDevicesHint: '「信頼する」に設定されたブラウザは、30日間2要素認証をスキップします。認識できないものは取り消してください。',
    trustedDevices_title: '信頼できるブラウザ',
    twoFactorAuthentication: '2要素認証',
    twoFactor_enabled: '2要素認証が有効です。',
    twoFactor_intro: '認証アプリによる時間ベースのワンタイムコードを使用して、アカウントにセキュリティ層を追加します。',
    unknownDevice: '不明なデバイス',
    verify: '確認',
  },
};
