...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: '通知サービスを追加',
      ...
      openBoardActions: 'ボードアクションを開く',
      openBoard_title: 'ボードを開く',
      openCardActions: 'カードアクションを開く',
      openListActions: 'リストアクションを開く',
      openNotifications: '通知を開く',
      openProjectActions: 'プロジェクトアクションを開く',
      ...
      showHiddenProjects: '非表示のプロジェクトを表示',
    ...
    action: {
      ...
      emptyTrash_title: 'ゴミ箱を空にする',
      enable2fa: '2FAを有効にする',
      enableEditMode: '編集モードを開始',
      filterByCurrentUser: '現在のユーザーで絞り込む',
      goBack: '戻る',
      hideHiddenProjects: '非表示のプロジェクトを隠す',
      hideProjectList: 'プロジェクトリストを非表示',
      import: 'インポート',
      join: '参加',
      leave: '退出',
      leaveBoard: 'ボードから退出',
      ...
      showLess: '表示を減らす',
      showMore: 'もっと表示',
      showProjectList: 'プロジェクトリストを表示',
      sortList_title: 'リストを並び替え',
      start: 'スタート',
      stayLoggedIn: 'ログインしたままにする',
      stop: 'ストップ',
      subscribe: '購読',
      switchToGridProjectsView: 'プロジェクトをグリッドで表示',
      switchToGridView: 'グリッドビューに切り替え',
      switchToGroupedProjectsView: 'プロジェクトをグループ化して表示',
      switchToKanbanView: 'カンバンビューに切り替え',
