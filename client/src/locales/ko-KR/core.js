...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: '알림 서비스 추가',
      ...
      openBoardActions: '보드 작업 열기',
      openBoard_title: '보드 열기',
      openCardActions: '카드 작업 열기',
      openListActions: '목록 작업 열기',
      openNotifications: '알림 열기',
      openProjectActions: '프로젝트 작업 열기',
      ...
      showHiddenProjects: '숨겨진 프로젝트 표시',
    ...
    action: {
      ...
      emptyTrash_title: '휴지통 비우기',
      enable2fa: '2FA 활성화',
      enableEditMode: '편집 모드 켜기',
      filterByCurrentUser: '현재 사용자별 필터링',
      goBack: '뒤로 가기',
      hideHiddenProjects: '숨겨진 프로젝트 숨기기',
      hideProjectList: '프로젝트 목록 숨기기',
      import: '가져오기',
      join: '참여',
      leave: '떠나기',
      leaveBoard: '보드 떠나기',
      ...
      showLess: '적게 표시',
      showMore: '더 표시',
      showProjectList: '프로젝트 목록 표시',
      sortList_title: '목록 정렬',
      start: '시작',
      stayLoggedIn: '로그인 상태 유지',
      stop: '중지',
      subscribe: '구독',
      switchToGridProjectsView: '프로젝트를 격자로 표시',
      switchToGridView: '격자 보기로 전환',
      switchToGroupedProjectsView: '프로젝트를 그룹별로 표시',
      switchToKanbanView: '칸반 보기로 전환',
