...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Přidat službu oznámení',
      ...
      autoLogout_10m: 'Po 10 minutách',
      autoLogout_12h: 'Po 12 hodinách',
      autoLogout_2m: 'Po 2 minutách',
      autoLogout_30m: 'Po 30 minutách',
      autoLogout_5m: 'Po 5 minutách',
      autoLogout_never: 'Nikdy',
      autoLogoutWarning_body: 'Z důvodu nečinnosti budete odhlášeni za {{seconds}} s.',
      autoLogoutWarning_title: 'Brzy budete odhlášeni',
      background: 'Pozadí',
      ...
      color: 'Barva',
      comments: 'Komentáře',
      confirmCodesSaved: 'Tyto kódy mám uložené na bezpečném místě.',
      ...
      proFeatureDashboard: '✨ Jeden dashboard napříč všemi projekty',
      proFeatureExport: '✨ Karty jako PDF pro vaše reporty',
      proFeatureMobile: '✨ PLANKA na mobilech a tabletech',
      proFeatureSso: '✨ Přihlášení přes firemní adresář (SSO)',
      proFeatureThemes: '✨ Pět motivů a vlastní barva zvýraznění',
      proFeatureTimeline: '✨ Timeline: celý rok na jedné ose',
      proTrialSelfHosted: '✨ Vyzkoušejte PLANKA Pro na 30 dní na vlastním serveru',
      dismissProBannerFor30Days: 'Zavřít na 30 dní',
      customerPanel_title: 'Panel zákazníka',
      dangerZone_title: 'Nebezpečná zóna',
      disable2fa_title: 'Deaktivovat dvoufaktorové ověření',
      disable2faWarning:
        'Budete muset potvrdit své aktuální heslo a kód TOTP. Stávající relace zůstanou přihlášené.',
      enable2fa_title: 'Aktivovat dvoufaktorové ověření',
      enabledOn: 'Aktivováno {{date}}',
      enterCodeFromApp: 'Zadejte 6místný kód z ověřovací aplikace.',
      enterPasswordToContinue: 'Pro pokračování potvrďte své aktuální heslo.',
      enterTotpOrRecoveryCode:
        'Zadejte 6místný kód z ověřovací aplikace nebo jeden ze záložních kódů (xxxxx-xxxxx).',
      expires: 'Platnost do',
      invalidTotpCode: 'Neplatný kód TOTP nebo záložní kód',
      lastUsed: 'Naposledy použito',
      never: 'Nikdy',
      noTrustedDevices: 'Žádná důvěryhodná zařízení.',
      openBoardActions: 'Otevřít akce nástěnky',
      openCardActions: 'Otevřít akce karty',
      openListActions: 'Otevřít akce seznamu',
      openNotifications: 'Otevřít oznámení',
      openProjectActions: 'Otevřít akce projektu',
      openProjectSettings: 'Otevřít nastavení projektu',
      orEnterSecretManually: 'Nebo zadejte tento tajný klíč ručně:',
      recoveryCodesExhausted:
        'Všechny záložní kódy byly použity. Vygenerujte novou sadu, abyste měli náhradní přístup pro případ ztráty ověřovací aplikace.',
      recoveryCodesIntro:
        'Uschovejte tyto kódy na bezpečném místě — každý z nich lze použít jednou, pokud ztratíte přístup k ověřovací aplikaci.',
      recoveryCodesLow_one: 'Zbývá už jen {{count}} záložní kód. Zvažte brzké vygenerování nových.',
      recoveryCodesLow_few:
        'Zbývají už jen {{count}} záložní kódy. Zvažte brzké vygenerování nových.',
      recoveryCodesLow_many:
        'Zbývá už jen {{count}} záložního kódu. Zvažte brzké vygenerování nových.',
      recoveryCodesLow_other:
        'Zbývá už jen {{count}} záložních kódů. Zvažte brzké vygenerování nových.',
      regenerateRecoveryCodes_title: 'Znovu vygenerovat záložní kódy',
      regenerateRecoveryCodesIntro:
        'Vygenerováním nových kódů se všechny stávající záložní kódy stanou neplatnými.',
      reset2fa_title: 'Resetovat 2FA',
      reset2faWarning:
        'Resetování 2FA odhlásí uživatele ze všech relací a odstraní jeho nastavení TOTP. Při příštím přihlášení si ho bude muset nastavit znovu.',
      saveTheseCodes_title: 'Uložte si tyto záložní kódy',
      scanQrCodeWithApp:
        'Naskenujte tento QR kód ověřovací aplikací, jako je Google Authenticator nebo Authy.',
      security_title: 'Zabezpečení',
      showHiddenProjects: 'Zobrazit skryté projekty',
      totpCode: 'Kód TOTP',
      totpOrRecoveryCode: 'Kód TOTP nebo záložní kód',
      trustedDevices_title: 'Důvěryhodné prohlížeče',
      trustedDevicesHint:
        'Prohlížeče označené jako důvěryhodné nevyžadují druhý faktor po dobu 30 dnů. Odvolejte ty, které již nepoznáváte.',
      twoFactor_enabled: 'Dvoufaktorové ověření je aktivováno.',
      twoFactor_intro:
        'Přidejte svému účtu další vrstvu zabezpečení pomocí jednorázového kódu založeného na čase z ověřovací aplikace.',
    ...
    action: {
      ...
      disable2fa: 'Deaktivovat 2FA',
      disableEditMode: 'Ukončit režim úprav',
      ...
      emptyTrash_title: 'Vyprázdnit koš',
      enable2fa: 'Aktivovat 2FA',
      enableEditMode: 'Spustit režim úprav',
      filterByCurrentUser: 'Filtrovat podle aktuálního uživatele',
      goBack: 'Zpět',
      hideHiddenProjects: 'Nezobrazovat skryté projekty',
      hideProjectList: 'Skrýt seznam projektů',
      import: 'Import',
      join: 'Připojit',
      leave: 'Opustit',
      ...
      regenerateRecoveryCodes: 'Znovu vygenerovat záložní kódy',
      remove: 'Odstranit',
      ...
      showProjectList: 'Zobrazit seznam projektů',
      sortList_title: 'Řadit podle',
      start: 'Start',
      stayLoggedIn: 'Zůstat přihlášen',
      stop: 'Stop',
      subscribe: 'Odebírat',
      switchToGridProjectsView: 'Zobrazit projekty jako mřížku',
      switchToGridView: 'Přepnout na zobrazení mřížky',
      switchToGroupedProjectsView: 'Zobrazit projekty ve skupinách',
      switchToKanbanView: 'Přepnout na zobrazení kanban',
