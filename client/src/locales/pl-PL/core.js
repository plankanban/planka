...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Dodaj serwis powiadomień',
      ...
      autoLogout_10m: 'Po 10 minutach',
      autoLogout_12h: 'Po 12 godzinach',
      autoLogout_2m: 'Po 2 minutach',
      autoLogout_30m: 'Po 30 minutach',
      autoLogout_5m: 'Po 5 minutach',
      autoLogout_never: 'Nigdy',
      autoLogoutWarning_body: 'Zostaniesz wylogowany za {{seconds}}s z powodu braku aktywności.',
      autoLogoutWarning_title: 'Wkrótce zostaniesz wylogowany',
      background: 'Tło',
      ...
      color: 'Kolor',
      comments: 'Komentarze',
      confirmCodesSaved: 'Mam te kody zapisane w bezpiecznym miejscu.',
      ...
      proFeatureDashboard: '✨ Jeden dashboard dla wszystkich projektów',
      proFeatureExport: '✨ Karty jako PDF do Twoich raportów',
      proFeatureMobile: '✨ PLANKA na telefonach i tabletach',
      proFeatureSso: '✨ Logowanie przez katalog firmowy (SSO)',
      proFeatureThemes: '✨ Pięć motywów i Twój własny kolor akcentu',
      proFeatureTimeline: '✨ Timeline: cały rok na jednej osi',
      proTrialSelfHosted: '✨ Wypróbuj PLANKA Pro przez 30 dni na własnym serwerze',
      dismissProBannerFor30Days: 'Zamknij na 30 dni',
      customerPanel_title: 'Panel klienta',
      dangerZone_title: 'Strefa niebezpieczeństwa',
      disable2fa_title: 'Wyłącz uwierzytelnianie dwuskładnikowe',
      disable2faWarning:
        'Musisz potwierdzić swoje obecne hasło oraz kod TOTP. Istniejące sesje pozostaną zalogowane.',
      enable2fa_title: 'Włącz uwierzytelnianie dwuskładnikowe',
      enabledOn: 'Włączono {{date}}',
      enterCodeFromApp: 'Wprowadź 6-cyfrowy kod z aplikacji uwierzytelniającej.',
      enterPasswordToContinue: 'Potwierdź swoje obecne hasło, aby kontynuować.',
      enterTotpOrRecoveryCode:
        'Wprowadź 6-cyfrowy kod z aplikacji uwierzytelniającej lub jeden z kodów odzyskiwania (xxxxx-xxxxx).',
      expires: 'Wygasa',
      invalidTotpCode: 'Błędny kod TOTP lub kod odzyskiwania',
      lastUsed: 'Ostatnio użyto',
      never: 'Nigdy',
      noTrustedDevices: 'Brak zaufanych urządzeń.',
      orEnterSecretManually: 'Lub wprowadź ten tajny klucz ręcznie:',
      recoveryCodesExhausted:
        'Wszystkie kody odzyskiwania zostały wykorzystane. Wygeneruj nowy zestaw, aby zachować zapasowy dostęp na wypadek utraty aplikacji uwierzytelniającej.',
      recoveryCodesIntro:
        'Przechowuj te kody w bezpiecznym miejscu — każdego z nich można użyć raz, jeśli utracisz dostęp do aplikacji uwierzytelniającej.',
      recoveryCodesLow_one:
        'Pozostał tylko {{count}} kod odzyskiwania. Warto wkrótce wygenerować nowe.',
      recoveryCodesLow_few:
        'Pozostały tylko {{count}} kody odzyskiwania. Warto wkrótce wygenerować nowe.',
      recoveryCodesLow_many:
        'Pozostało tylko {{count}} kodów odzyskiwania. Warto wkrótce wygenerować nowe.',
      recoveryCodesLow_other:
        'Pozostało tylko {{count}} kodu odzyskiwania. Warto wkrótce wygenerować nowe.',
      regenerateRecoveryCodes_title: 'Wygeneruj ponownie kody odzyskiwania',
      regenerateRecoveryCodesIntro:
        'Wygenerowanie nowych kodów unieważni wszystkie istniejące kody odzyskiwania.',
      reset2fa_title: 'Zresetuj 2FA',
      reset2faWarning:
        'Zresetowanie 2FA wyloguje użytkownika ze wszystkich sesji i usunie jego konfigurację TOTP. Przy następnym logowaniu będzie musiał skonfigurować ją ponownie.',
      saveTheseCodes_title: 'Zapisz te kody odzyskiwania',
      scanQrCodeWithApp:
        'Zeskanuj ten kod QR aplikacją uwierzytelniającą, taką jak Google Authenticator lub Authy.',
      security_title: 'Bezpieczeństwo',
      totpCode: 'Kod TOTP',
      totpOrRecoveryCode: 'Kod TOTP lub kod odzyskiwania',
      trustedDevices_title: 'Zaufane przeglądarki',
      trustedDevicesHint:
        'Przeglądarki oznaczone jako zaufane pomijają drugi składnik uwierzytelniania przez 30 dni. Unieważnij te, których już nie rozpoznajesz.',
      twoFactor_enabled: 'Uwierzytelnianie dwuskładnikowe jest włączone.',
      twoFactor_intro:
        'Dodaj do swojego konta dodatkową warstwę zabezpieczeń, używając jednorazowego kodu czasowego z aplikacji uwierzytelniającej.',
      ...
      openBoardActions: 'Otwórz akcje tablicy',
      openBoard_title: 'Otwórz tablicę',
      openCardActions: 'Otwórz akcje karty',
      openListActions: 'Otwórz akcje listy',
      openNotifications: 'Otwórz powiadomienia',
      openProjectActions: 'Otwórz akcje projektu',
      ...
      showHiddenProjects: 'Pokaż ukryte projekty',
    ...
    action: {
      ...
      disableEditMode: 'Wyłącz tryb edycji',
      ...
      emptyTrash_title: 'Opróżnij kosz',
      enable2fa: 'Włącz 2FA',
      enableEditMode: 'Włącz tryb edycji',
      filterByCurrentUser: 'Filtruj po bieżącym użytkowniku',
      goBack: 'Wstecz',
      hideHiddenProjects: 'Ukryj ukryte projekty',
      hideProjectList: 'Ukryj listę projektów',
      import: 'Importuj',
      join: 'Dołącz',
      leave: 'Opuść',
      ...
      returnToProjects: 'Wróć do projektów',
      revoke: 'Unieważnij',
      save: 'Zapisz',
      ...
      showProjectList: 'Pokaż listę projektów',
      sortList_title: 'Sortuj listę',
      start: 'Start',
      stayLoggedIn: 'Pozostań zalogowany',
      stop: 'Stop',
      subscribe: 'Subskrybuj',
      switchToGridProjectsView: 'Pokaż projekty jako siatkę',
      switchToGridView: 'Przełącz na widok siatki',
      switchToGroupedProjectsView: 'Pokaż projekty pogrupowane',
