...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: '新增通知服務',
      ...
      authentication: '驗證',
      autoLogout: '自動登出',
      autoLogout_10m: '10 分鐘後',
      autoLogout_12h: '12 小時後',
      autoLogout_2m: '2 分鐘後',
      autoLogout_30m: '30 分鐘後',
      autoLogout_5m: '5 分鐘後',
      autoLogout_never: '永不',
      autoLogoutWarning_body: '由於閒置，您將在 {{seconds}} 秒後登出。',
      autoLogoutWarning_title: '您即將被登出',
      background: '背景',
      ...
      color: '顏色',
      comments: '評論',
      confirmCodesSaved: '我已將這些復原碼儲存在安全的地方。',
      ...
      proFeatureDashboard: '✨ 跨所有專案的單一儀表板',
      proFeatureExport: '✨ 將卡片匯出為 PDF 供報告使用',
      proFeatureMobile: '✨ 在手機與平板上使用 PLANKA',
      proFeatureSso: '✨ 使用公司目錄登入 (SSO)',
      proFeatureThemes: '✨ 五種佈景主題與您專屬的強調色',
      proFeatureTimeline: '✨ 時間軸：一整年在同一條軸線上',
      proTrialSelfHosted: '✨ 在您自己的伺服器上試用 PLANKA Pro 30 天',
      dismissProBannerFor30Days: '關閉 30 天',
      customerPanel_title: '客戶面板',
      dangerZone_title: '危險區域',
      disable2fa_title: '停用雙因素驗證',
      disable2faWarning: '您需要確認目前的密碼與一組 TOTP 驗證碼。現有的工作階段會維持登入狀態。',
      enable2fa_title: '啟用雙因素驗證',
      enabledOn: '啟用於 {{date}}',
      enterCodeFromApp: '請輸入驗證器應用程式產生的 6 位數驗證碼。',
      enterPasswordToContinue: '請確認您目前的密碼以繼續。',
      enterTotpOrRecoveryCode:
        '請輸入驗證器應用程式產生的 6 位數驗證碼，或其中一組復原碼 (xxxxx-xxxxx)。',
      expires: '到期時間',
      invalidTotpCode: '無效的 TOTP 或復原碼',
      lastUsed: '上次使用',
      never: '從未',
      noTrustedDevices: '沒有受信任的裝置。',
      openBoardActions: '開啟看板操作',
      openCardActions: '開啟卡片操作',
      openListActions: '開啟列表操作',
      openNotifications: '開啟通知',
      openProjectActions: '開啟專案操作',
      openProjectSettings: '開啟專案設定',
      orEnterSecretManually: '或手動輸入此金鑰：',
      recoveryCodesExhausted:
        '所有復原碼都已使用。請重新產生一組新的復原碼，以便在遺失驗證器應用程式時仍有備援方式。',
      recoveryCodesIntro:
        '請將這些復原碼儲存在安全的地方——若您無法存取驗證器應用程式，每組復原碼皆可使用一次。',
      recoveryCodesLow_other: '僅剩 {{count}} 組復原碼，請考慮盡快重新產生。',
      regenerateRecoveryCodes_title: '重新產生復原碼',
      regenerateRecoveryCodesIntro: '產生新的復原碼會使所有現有的復原碼失效。',
      reset2fa_title: '重設 2FA',
      reset2faWarning:
        '重設 2FA 會將該使用者從所有工作階段登出，並移除其 TOTP 設定。該使用者必須在下次登入時重新設定。',
      saveTheseCodes_title: '儲存這些復原碼',
      scanQrCodeWithApp: '請使用 Google Authenticator 或 Authy 等驗證器應用程式掃描此 QR 碼。',
      security_title: '安全性',
      showHiddenProjects: '顯示隱藏的專案',
      totpCode: 'TOTP 驗證碼',
      totpOrRecoveryCode: 'TOTP 或復原碼',
      trustedDevices_title: '受信任的瀏覽器',
      trustedDevicesHint:
        '被標記為受信任的瀏覽器在 30 天內可略過第二階段驗證。請撤銷任何您已不再認得的瀏覽器。',
      twoFactor_enabled: '雙因素驗證已啟用。',
      twoFactor_intro:
        '使用驗證器應用程式產生的時效性一次性驗證碼，為您的帳號增加一層額外的安全防護。',
      twoFactorAuthentication: '雙因素驗證',
      unknownDevice: '未知裝置',
      date: '日期',
    ...
    action: {
      ...
      emptyTrash_title: '清空垃圾桶',
      enable2fa: '啟用 2FA',
      enableEditMode: '啟用編輯模式',
      filterByCurrentUser: '依目前使用者篩選',
      goBack: '返回',
      hideHiddenProjects: '不顯示隱藏的專案',
      hideProjectList: '隱藏專案列表',
      import: '導入',
      join: '加入',
      leave: '離開',
      leaveBoard: '離開看板',
      ...
      showLess: '顯示較少',
      showMore: '顯示更多',
      showProjectList: '顯示專案列表',
      sortList_title: '排序列表',
      start: '開始',
      stayLoggedIn: '保持登入',
      stop: '結束',
      subscribe: '訂閱',
      switchToGridProjectsView: '以網格顯示專案',
      switchToGridView: '切換至網格檢視',
      switchToGroupedProjectsView: '分組顯示專案',
      switchToKanbanView: '切換至看板檢視',
