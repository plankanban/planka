...
export default {
  ...
  translation: {
    common: {
      ...
      authentication: '驗證',
      autoLogout: '自動登出',
      autoLogout_10m: '閒置 10 分鐘後',
      autoLogout_12h: '閒置 12 小時後',
      autoLogout_2m: '閒置 2 分鐘後',
      autoLogout_30m: '閒置 30 分鐘後',
      autoLogout_5m: '閒置 5 分鐘後',
      autoLogout_never: '永不',
      autoLogoutWarning_body: '由於閒置，您將在 {{seconds}} 秒後登出。',
      autoLogoutWarning_title: '您即將登出',
      background: '背景',
      ...
      color: '顏色',
      comments: '評論',
      confirmCodesSaved: '我已將這些復原碼儲存在安全的位置。',
      ...
      disable2faWarning: '您需要確認目前的密碼與 TOTP 驗證碼。現有工作階段將保持登入。',
      date: '日期',
      ...
      enabledOn: '啟用日期：{{date}}',
      enterCodeFromApp: '輸入驗證器應用程式中的 6 位數驗證碼。',
      enterPasswordToContinue: '確認您目前的密碼以繼續。',
      enterTotpOrRecoveryCode:
        '輸入驗證器應用程式中的 6 位數驗證碼，或輸入一組復原碼（xxxxx-xxxxx）。',
      ...
      invalidTotpCode: 'TOTP 驗證碼或復原碼無效',
      kanban: '看板',
      labels: '標籤',
      language: '語言',
      lastUsed: '上次使用',
      ...
      optional_inline: '可選的',
      orEnterSecretManually: '或手動輸入此密鑰：',
      organization: '組織機構',
      others: '其他',
      passwordIsSet: '密碼已設定',
      phone: '電話',
      ...
      recoveryCodesExhausted:
        '所有復原碼都已使用。請重新產生一組復原碼，以便在無法使用驗證器應用程式時仍能登入。',
      recoveryCodesIntro:
        '請將這些復原碼儲存在安全的位置；如果無法使用驗證器應用程式，每組復原碼皆可使用一次。',
      recoveryCodesLow_one: '只剩 {{count}} 組復原碼，建議儘快重新產生。',
      recoveryCodesLow_other: '只剩 {{count}} 組復原碼，建議儘快重新產生。',
      regenerateApiKey_title: '重新產生API金鑰',
      regenerateRecoveryCodes_title: '重新產生復原碼',
      regenerateRecoveryCodesIntro: '產生新復原碼後，所有現有的復原碼都會失效。',
      rejectUnauthorizedTlsCertificates: '拒絕未授權的 TLS 憑證',
      removeManager_title: '刪除管理員',
      removeMember_title: '刪除成員',
      reset2fa_title: '重設雙因素驗證',
      reset2faWarning:
        '重設雙因素驗證會將使用者登出所有工作階段，並移除其 TOTP 設定。使用者下次登入時必須重新設定。',
      role: '角色',
      saveTheseCodes_title: '儲存這些復原碼',
      saveThisKeyItWillNotBeShownAgain: '儲存此金鑰——它不會再次顯示！',
      scanQrCodeWithApp: '使用 Google Authenticator 或 Authy 等驗證器應用程式掃描此 QR Code。',
      searchCards: '搜尋卡片...',
