...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'اضافه کردن سرویس اعلان',
      ...
      autoLogout_10m: 'پس از ۱۰ دقیقه',
      autoLogout_12h: 'پس از ۱۲ ساعت',
      autoLogout_2m: 'پس از ۲ دقیقه',
      autoLogout_30m: 'پس از ۳۰ دقیقه',
      autoLogout_5m: 'پس از ۵ دقیقه',
      autoLogout_never: 'هرگز',
      autoLogoutWarning_body: 'به دلیل عدم فعالیت، تا {{seconds}} ثانیه دیگر از حساب خارج می‌شوید.',
      autoLogoutWarning_title: 'به‌زودی از حساب خارج می‌شوید',
      background: 'پس‌زمینه',
      ...
      color: 'رنگ',
      comments: 'نظرات',
      confirmCodesSaved: 'این کدها را در جای امنی ذخیره کرده‌ام.',
      ...
      proFeatureDashboard: '✨ یک داشبورد برای همه پروژه‌ها',
      proFeatureExport: '✨ کارت‌ها به صورت PDF برای گزارش‌های شما',
      proFeatureMobile: '✨ PLANKA روی موبایل و تبلت',
      proFeatureSso: '✨ ورود با دایرکتوری سازمان شما (SSO)',
      proFeatureThemes: '✨ پنج پوسته و رنگ تأکیدی دلخواه شما',
      proFeatureTimeline: '✨ تایم‌لاین: یک سال کامل روی یک محور',
      proTrialSelfHosted: '✨ PLANKA Pro را ۳۰ روز روی سرور خودتان امتحان کنید',
      ...
      description: 'توضیحات',
      disable2fa_title: 'غیرفعال کردن احراز هویت دو مرحله‌ای',
      disable2faWarning:
        'باید رمز عبور فعلی و یک کد TOTP را تأیید کنید. نشست‌های موجود همچنان وارد باقی می‌مانند.',
      display: 'نمایش',
      ...
      enable2fa_title: 'فعال کردن احراز هویت دو مرحله‌ای',
      enabledOn: 'فعال شده در {{date}}',
      enterCardTitle: 'عنوان کارت را وارد کنید...',
      enterCodeFromApp: 'کد ۶ رقمی برنامه احراز هویت خود را وارد کنید.',
      enterDescription: 'توضیحات را وارد کنید...',
      enterFilename: 'نام فایل را وارد کنید',
      enterListTitle: 'عنوان لیست را وارد کنید...',
      enterPasswordToContinue: 'برای ادامه، رمز عبور فعلی خود را تأیید کنید.',
      enterTaskDescription: 'توضیحات وظیفه را وارد کنید...',
      enterTotpOrRecoveryCode:
        'کد ۶ رقمی برنامه احراز هویت خود یا یکی از کدهای بازیابی (xxxxx-xxxxx) را وارد کنید.',
      events: 'رویدادها',
      ...
      invalidTotpCode: 'کد TOTP یا کد بازیابی نامعتبر است',
      kanban: 'کانبان',
      labels: 'برچسب‌ها',
      language: 'زبان',
      ...
      noTrustedDevices: 'دستگاه مورد اعتمادی وجود ندارد.',
      ...
      openBoardActions: 'باز کردن اقدامات برد',
      openBoard_title: 'باز کردن برد',
      openCardActions: 'باز کردن اقدامات کارت',
      openListActions: 'باز کردن اقدامات لیست',
      openNotifications: 'باز کردن اعلان‌ها',
      openProjectActions: 'باز کردن اقدامات پروژه',
      openProjectSettings: 'باز کردن تنظیمات پروژه',
      optional_inline: 'اختیاری',
      orEnterSecretManually: 'یا این کلید مخفی را به صورت دستی وارد کنید:',
      organization: 'سازمان',
      others: 'دیگران',
      ...
      recoveryCodesExhausted:
        'همه کدهای بازیابی استفاده شده‌اند. مجموعه جدیدی بسازید تا اگر برنامه احراز هویت خود را از دست دادید، راه جایگزینی داشته باشید.',
      recoveryCodesIntro:
        'این کدها را در جای امنی نگه دارید — اگر دسترسی به برنامه احراز هویت خود را از دست بدهید، هر کد یک بار قابل استفاده است.',
      recoveryCodesLow_one:
        'فقط {{count}} کد بازیابی باقی مانده است. بهتر است به‌زودی کدهای جدید بسازید.',
      ...
      regenerateRecoveryCodes_title: 'بازسازی کدهای بازیابی',
      regenerateRecoveryCodesIntro: 'با ساخت کدهای جدید، همه کدهای بازیابی موجود باطل می‌شوند.',
      ...
      reset2fa_title: 'بازنشانی 2FA',
      reset2faWarning:
        'بازنشانی 2FA کاربر را از همه نشست‌ها خارج می‌کند و تنظیمات TOTP او را حذف می‌کند. او باید در ورود بعدی دوباره آن را تنظیم کند.',
      role: 'نقش',
      saveTheseCodes_title: 'این کدهای بازیابی را ذخیره کنید',
      saveThisKeyItWillNotBeShownAgain: 'این کلید را ذخیره کنید — دیگر نشان داده نخواهد شد!',
      scanQrCodeWithApp:
        'این کد QR را با یک برنامه احراز هویت مانند Google Authenticator یا Authy اسکن کنید.',
      ...
      showHiddenProjects: 'نمایش پروژه‌های مخفی',
      ...
      title: 'عنوان',
      totpCode: 'کد TOTP',
      totpOrRecoveryCode: 'کد TOTP یا کد بازیابی',
      trash: 'سطل زباله',
      trashHasBeenSuccessfullyEmptied: 'سطل زباله با موفقیت خالی شد.',
      trustedDevices_title: 'مرورگرهای مورد اعتماد',
      trustedDevicesHint:
        'مرورگرهایی که به عنوان مورد اعتماد علامت‌گذاری شده‌اند، به مدت ۳۰ روز مرحله دوم را رد می‌کنند. هر موردی را که دیگر نمی‌شناسید باطل کنید.',
      turnOffRecentCardHighlighting: 'خاموش کردن برجسته‌سازی کارت‌های اخیر',
      twoFactor_enabled: 'احراز هویت دو مرحله‌ای فعال است.',
      twoFactor_intro:
        'با استفاده از کد یک‌بارمصرف مبتنی بر زمان از یک برنامه احراز هویت، لایه امنیتی بیشتری به حساب خود اضافه کنید.',
    ...
    action: {
      ...
      disableEditMode: 'غیرفعال کردن حالت ویرایش',
      ...
      enableEditMode: 'فعال کردن حالت ویرایش',
      filterByCurrentUser: 'فیلتر بر اساس کاربر فعلی',
      goBack: 'بازگشت',
      hideHiddenProjects: 'پنهان کردن پروژه‌های مخفی',
      hideProjectList: 'مخفی کردن لیست پروژه‌ها',
      import: 'وارد کردن',
      join: 'پیوستن',
      leave: 'ترک کردن',
      leaveBoard: 'ترک برد',
      ...
      regenerateRecoveryCodes: 'بازسازی کدهای بازیابی',
      remove: 'حذف',
      ...
      returnToProjects: 'بازگشت به پروژه‌ها',
      revoke: 'ابطال',
      save: 'ذخیره',
      ...
      showProjectList: 'نمایش لیست پروژه‌ها',
      sortList_title: 'مرتب‌سازی لیست',
      start: 'شروع',
      stayLoggedIn: 'وارد بمانید',
      stop: 'توقف',
      subscribe: 'مشترک شدن',
      switchToGridProjectsView: 'نمایش پروژه‌ها به صورت شبکه‌ای',
      switchToGridView: 'تغییر به نمای شبکه‌ای',
      switchToGroupedProjectsView: 'نمایش پروژه‌ها به صورت گروه‌بندی شده',
      switchToKanbanView: 'تغییر به نمای کانبان',
      switchToListView: 'تغییر به نمای لیستی',
