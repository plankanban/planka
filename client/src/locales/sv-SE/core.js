...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisApiKey: 'Är du säker på att du vill ta bort den här API-nyckeln?',
      ...
      areYouSureYouWantToRegenerateThisApiKey:
        'Är du säker på att du vill generera en ny API-nyckel? Den tidigare nyckeln slutar fungera.',
      ...
      autoLogoutWarning_body: 'Du loggas ut om {{seconds}} sekunder på grund av inaktivitet.',
      autoLogoutWarning_title: 'Du loggas snart ut',
      background: 'Bakgrund',
      ...
      canEditBoardLayoutAndAssignMembersToCards:
        'Kan redigera tavlans layout och tilldela medlemmar till kort.',
      ...
      cardsOnThisListAreAvailableToAllBoardMembers:
        'Kort på den här listan är tillgängliga för alla medlemmar på tavlan.',
      ...
      confirmCodesSaved: 'Jag har sparat dessa koder på en säker plats.',
      ...
      disable2faWarning:
        'Du måste bekräfta ditt nuvarande lösenord och ange en TOTP-kod. Befintliga sessioner förblir aktiva.',
      enable2fa_title: 'Aktivera tvåfaktorsautentisering',
      enabledOn: 'Aktiverad den {{date}}',
      enterCodeFromApp: 'Ange den sexsiffriga koden från din autentiseringsapp.',
      enterPasswordToContinue: 'Bekräfta ditt nuvarande lösenord för att fortsätta.',
      enterTotpOrRecoveryCode:
        'Ange den sexsiffriga koden från din autentiseringsapp eller en av dina återställningskoder (xxxxx-xxxxx).',
      expires: 'Upphör',
      invalidTotpCode: 'Ogiltig TOTP- eller återställningskod',
      lastUsed: 'Senast använd',
      never: 'Aldrig',
      noTrustedDevices: 'Inga betrodda webbläsare.',
      orEnterSecretManually: 'Eller ange den hemliga nyckeln manuellt:',
      recoveryCodesExhausted:
        'Alla återställningskoder har använts. Generera en ny uppsättning så att du fortfarande har en reserv om du förlorar åtkomsten till autentiseringsappen.',
      recoveryCodesIntro:
        'Spara dessa koder på en säker plats — varje kod kan användas en gång om du förlorar åtkomsten till autentiseringsappen.',
      recoveryCodesLow_one:
        'Endast {{count}} återställningskod återstår. Överväg att generera nya koder snart.',
      recoveryCodesLow_other:
        'Endast {{count}} återställningskoder återstår. Överväg att generera nya koder snart.',
      regenerateRecoveryCodes_title: 'Generera nya återställningskoder',
      regenerateRecoveryCodesIntro:
        'Om du genererar nya koder blir alla befintliga återställningskoder ogiltiga.',
      reset2fa_title: 'Återställ tvåfaktorsautentisering',
      reset2faWarning:
        'Om du återställer tvåfaktorsautentiseringen loggas användaren ut från alla sessioner och TOTP-konfigurationen tas bort. Användaren måste konfigurera den igen vid nästa inloggning.',
      saveTheseCodes_title: 'Spara dessa återställningskoder',
      scanQrCodeWithApp:
        'Skanna QR-koden med en autentiseringsapp, till exempel Google Authenticator eller Authy.',
      security_title: 'Säkerhet',
      totpCode: 'TOTP-kod',
      totpOrRecoveryCode: 'TOTP- eller återställningskod',
      trustedDevices_title: 'Betrodda webbläsare',
      trustedDevicesHint:
        'Webbläsare som har markerats som betrodda hoppar över den andra faktorn i 30 dagar. Återkalla förtroendet för webbläsare du inte längre känner igen.',
      twoFactor_enabled: 'Tvåfaktorsautentisering är aktiverad.',
      twoFactor_intro:
        'Lägg till ett extra säkerhetslager för ditt konto med en tidsbaserad engångskod från en autentiseringsapp.',
      ...
      fullKeyIsHiddenForSecurityReasons:
        'Den fullständiga nyckeln är dold av säkerhetsskäl. Generera en ny nyckel för att ersätta den.',
      general: 'Allmänt',
      ...
      onlyOneManagerShouldRemainToMakeThisProjectPrivate:
        'Endast en projektledare får vara kvar för att göra projektet privat',
      ...
      thereIsNoPreviewAvailableForThisAttachment:
        'Det går inte att förhandsvisa den här bilagan.',
      time: 'Tid',
      title: 'Titel',
      trash: 'Papperskorg',
    ...
    action: {
      ...
      regenerateRecoveryCodes: 'Generera nya återställningskoder',
      remove: 'Ta bort',
