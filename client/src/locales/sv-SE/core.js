...
export default {
  ...
  format: {
    ...
    longDate: 'd MMM',
    longDateTime: "d MMMM 'kl.' p",
    fullDate: 'd MMM y',
    fullDateTime: "d MMMM y 'kl.' p",
  },
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Lägg till aviseringstjänst',
      ...
      areYouSureYouWantToDeleteThisApiKey:
        'Är du säker på att du vill ta bort den här API-nyckeln?',
      ...
      autoLogout_10m: 'Efter 10 minuter',
      autoLogout_12h: 'Efter 12 timmar',
      autoLogout_2m: 'Efter 2 minuter',
      autoLogout_30m: 'Efter 30 minuter',
      autoLogout_5m: 'Efter 5 minuter',
      autoLogout_never: 'Aldrig',
      autoLogoutWarning_body: 'Du loggas ut om {{seconds}}s på grund av inaktivitet.',
      autoLogoutWarning_title: 'Du loggas ut snart',
      background: 'Bakgrund',
      ...
      boardSubscribed: 'Prenumererar på tavlan',
      ...
      canOnlyViewBoard: 'Kan endast visa tavlan.',
      ...
      cardsOnThisListAreReadyToBeWorkedOn: 'Kort på den här listan är redo att börja hanteras.',
      clickHereOrRefreshPageToUpdate: '<0>Klicka här</0> eller uppdatera sidan.',
      clientHostnameInEhlo: 'Klientvärdnamn i EHLO',
      closed: 'Stängd',
      color: 'Färg',
      comments: 'Kommentarer',
      confirmCodesSaved: 'Jag har sparat de här koderna på ett säkert ställe.',
      ...
      discoverPlankaPro: '✨ Fler funktioner för dina tavlor: Upptäck PLANKA Pro',
      discoverPlankaPro_title: 'Upptäck PLANKA Pro',
      upgradeTeamToPro_title: 'Uppgradera teamet till Pro',
      proFeatureCalendar: '✨ Kalendervy för dina tavlor',
      proFeatureRecurringCards: '✨ Återkommande kort',
      proFeatureGuestRoles: '✨ Gästroller och externt samarbete',
      proFeatureDashboard: '✨ En dashboard för alla projekt',
      proFeatureExport: '✨ Kort som PDF för din rapportering',
      proFeatureMobile: '✨ PLANKA på mobil och surfplatta',
      proFeatureSso: '✨ Logga in med företagets katalogtjänst (SSO)',
      proFeatureThemes: '✨ Fem teman och din egen accentfärg',
      proFeatureTimeline: '✨ Tidslinje: hela året på en axel',
      proTrialSelfHosted: '✨ Testa PLANKA Pro i 30 dagar på din egen server',
      dismissProBannerFor30Days: 'Dölj i 30 dagar',
      customerPanel_title: 'Kundpanel',
      dangerZone_title: 'Farozon',
      disable2fa_title: 'Inaktivera tvåfaktorsautentisering',
      disable2faWarning:
        'Du måste bekräfta ditt nuvarande lösenord och en TOTP-kod. Befintliga sessioner förblir inloggade.',
      enable2fa_title: 'Aktivera tvåfaktorsautentisering',
      enabledOn: 'Aktiverad {{date}}',
      enterCodeFromApp: 'Ange den 6-siffriga koden från din autentiseringsapp.',
      enterPasswordToContinue: 'Bekräfta ditt nuvarande lösenord för att fortsätta.',
      ...
      never: 'Aldrig',
      noTrustedDevices: 'Inga betrodda enheter.',
      openBoardActions: 'Öppna tavlåtgärder',
      openCardActions: 'Öppna kortåtgärder',
      openListActions: 'Öppna liståtgärder',
      openNotifications: 'Öppna notifikationer',
      openProjectActions: 'Öppna projektåtgärder',
      openProjectSettings: 'Öppna projektinställningar',
      orEnterSecretManually: 'Eller ange denna hemliga nyckel manuellt:',
      recoveryCodesExhausted:
        'Alla återställningskoder har använts. Generera en ny uppsättning för att ha en reserv om du förlorar din autentiseringsapp.',
      recoveryCodesIntro:
        'Förvara de här koderna på ett säkert ställe — varje kod kan användas en gång om du förlorar åtkomsten till din autentiseringsapp.',
      recoveryCodesLow_one:
        'Endast {{count}} återställningskod kvar. Överväg att generera nya snart.',
      recoveryCodesLow_other:
        'Endast {{count}} återställningskoder kvar. Överväg att generera nya snart.',
      regenerateRecoveryCodes_title: 'Regenerera återställningskoder',
      regenerateRecoveryCodesIntro:
        'Att generera nya koder gör alla befintliga återställningskoder ogiltiga.',
      reset2fa_title: 'Återställ 2FA',
      reset2faWarning:
        'Att återställa 2FA loggar ut användaren från alla sessioner och tar bort användarens TOTP-konfiguration. Användaren måste ställa in den på nytt vid nästa inloggning.',
      saveTheseCodes_title: 'Spara dessa återställningskoder',
      scanQrCodeWithApp:
        'Skanna den här QR-koden med en autentiseringsapp som Google Authenticator eller Authy.',
      security_title: 'Säkerhet',
      showHiddenProjects: 'Visa dolda projekt',
      totpCode: 'TOTP-kod',
      totpOrRecoveryCode: 'TOTP- eller återställningskod',
      trustedDevices_title: 'Betrodda webbläsare',
      trustedDevicesHint:
        'Webbläsare som har markerats som betrodda hoppar över den andra faktorn i 30 dagar. Återkalla de som du inte längre känner igen.',
      twoFactor_enabled: 'Tvåfaktorsautentisering är aktiverad.',
      twoFactor_intro:
        'Lägg till ett extra säkerhetslager på ditt konto med en tidsbaserad engångskod från en autentiseringsapp.',
      ...
      editEmail_title: 'Redigera e-postadress',
      ...
      editStopwatch_title: 'Redigera stoppur',
      ...
      hideFromProjectListAndFavorites: 'Dölj från projektlistan och favoriter',
      host: 'Värd',
      hours: 'Timmar',
      identity: 'Identitet',
      ...
      noUnreadNotifications: 'Inga olästa aviseringar.',
      ...
      others: 'Andra',
      passwordIsSet: 'Lösenordet är inställt',
      phone: 'Telefon',
      ...
      regenerateApiKey_title: 'Generera ny API-nyckel',
      ...
      seconds: 'Sekunder',
      selectAssignee_title: 'Välj ansvarig',
      selectBoard: 'Välj tavla',
      selectList: 'Välj lista',
      selectListToRestoreThisCard: 'Välj en lista att återställa det här kortet till',
      ...
      taskListActions_title: 'Åtgärder för uppgiftslista',
      ...
      title: 'Titel',
      trash: 'Papperskorg',
      trashHasBeenSuccessfullyEmptied: 'Papperskorgen har tömts.',
      turnOffRecentCardHighlighting: 'Stäng av markering av senaste kort',
      typeNameToConfirm: 'Skriv namnet för att bekräfta.',
      typeTitleToConfirm: 'Skriv titeln för att bekräfta.',
    ...
    action: {
      ...
      disableEditMode: 'Inaktivera redigeringsläge',
      ...
      enableEditMode: 'Aktivera redigeringsläge',
      filterByCurrentUser: 'Filtrera efter aktuell användare',
      goBack: 'Gå tillbaka',
      hideHiddenProjects: 'Dölj dolda projekt',
      hideProjectList: 'Dölj projektlista',
      import: 'Importera',
      join: 'Gå med',
      leave: 'Lämna',
      ...
      regenerateApiKey: 'Generera ny API-nyckel',
      regenerateRecoveryCodes: 'Regenerera återställningskoder',
      remove: 'Ta bort',
      removeAssignee: 'Ta bort ansvarig',
      ...
      reset2fa: 'Återställ 2FA',
      restoreToList: 'Återställ till {{list}}',
      returnToBoard: 'Återgå till tavla',
      returnToProjects: 'Återgå till projekt',
      revoke: 'Återkalla',
      save: 'Spara',
      sendTestEmail: 'Skicka test-e-post',
      showActive: 'Visa aktiva',
      showAllAttachments: 'Visa alla bilagor ({{hidden}} dolda)',
      showCardsWithThisUser: 'Visa kort med den här användaren',
      showDeactivated: 'Visa inaktiverade',
      showFewerAttachments: 'Visa färre bilagor',
      showLess: 'Visa mindre',
      showMore: 'Visa mer',
      showProjectList: 'Visa projektlista',
      sortList_title: 'Sortera lista',
      start: 'Starta',
      stayLoggedIn: 'Förbli inloggad',
      stop: 'Stoppa',
      subscribe: 'Prenumerera',
      switchToGridProjectsView: 'Visa projekt som rutnät',
      switchToGridView: 'Växla till rutnätsvy',
      switchToGroupedProjectsView: 'Visa projekt grupperade',
      switchToKanbanView: 'Växla till kanbanvy',
      switchToListView: 'Växla till listvy',
