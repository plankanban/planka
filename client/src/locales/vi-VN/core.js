...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Thêm dịch vụ thông báo',
      ...
      autoLogout_10m: 'Sau 10 phút',
      autoLogout_12h: 'Sau 12 giờ',
      autoLogout_2m: 'Sau 2 phút',
      autoLogout_30m: 'Sau 30 phút',
      autoLogout_5m: 'Sau 5 phút',
      autoLogout_never: 'Không bao giờ',
      autoLogoutWarning_body: 'Bạn sẽ bị đăng xuất sau {{seconds}} giây do không hoạt động.',
      autoLogoutWarning_title: 'Bạn sắp bị đăng xuất',
      background: 'Nền',
      ...
      color: 'Màu sắc',
      comments: 'Bình luận',
      confirmCodesSaved: 'Tôi đã lưu các mã này ở một nơi an toàn.',
      ...
      proFeatureDashboard: '✨ Một bảng điều khiển cho mọi dự án',
      proFeatureExport: '✨ Xuất thẻ ra PDF cho báo cáo của bạn',
      proFeatureMobile: '✨ PLANKA trên điện thoại và máy tính bảng',
      proFeatureSso: '✨ Đăng nhập bằng thư mục công ty của bạn (SSO)',
      proFeatureThemes: '✨ Năm giao diện và màu nhấn của riêng bạn',
      proFeatureTimeline: '✨ Dòng thời gian: cả năm trên một trục',
      proTrialSelfHosted: '✨ Dùng thử PLANKA Pro 30 ngày trên máy chủ của bạn',
      ...
      disable2fa_title: 'Tắt xác thực hai yếu tố',
      disable2faWarning:
        'Bạn sẽ cần xác nhận mật khẩu hiện tại và một mã TOTP. Các phiên đăng nhập hiện có vẫn được duy trì.',
      enable2fa_title: 'Bật xác thực hai yếu tố',
      enabledOn: 'Đã bật vào {{date}}',
      enterCodeFromApp: 'Nhập mã 6 chữ số từ ứng dụng xác thực của bạn.',
      enterPasswordToContinue: 'Xác nhận mật khẩu hiện tại của bạn để tiếp tục.',
      enterTotpOrRecoveryCode:
        'Nhập mã 6 chữ số từ ứng dụng xác thực của bạn, hoặc một trong các mã khôi phục (xxxxx-xxxxx).',
      expires: 'Hết hạn',
      invalidTotpCode: 'Mã TOTP hoặc mã khôi phục không hợp lệ',
      lastUsed: 'Lần sử dụng cuối',
      never: 'Không bao giờ',
      noTrustedDevices: 'Không có thiết bị tin cậy nào.',
      orEnterSecretManually: 'Hoặc nhập khóa bí mật này thủ công:',
      recoveryCodesExhausted:
        'Tất cả các mã khôi phục đã được sử dụng. Hãy tạo lại một bộ mã mới để có phương án dự phòng trong trường hợp bạn mất ứng dụng xác thực.',
      recoveryCodesIntro:
        'Hãy lưu các mã này ở một nơi an toàn — mỗi mã chỉ có thể sử dụng một lần nếu bạn mất quyền truy cập vào ứng dụng xác thực.',
      recoveryCodesLow_other: 'Chỉ còn lại {{count}} mã khôi phục. Hãy cân nhắc tạo lại sớm.',
      regenerateRecoveryCodes_title: 'Tạo lại mã khôi phục',
      regenerateRecoveryCodesIntro:
        'Việc tạo mã mới sẽ làm vô hiệu tất cả các mã khôi phục hiện có.',
      reset2fa_title: 'Đặt lại 2FA',
      reset2faWarning:
        'Việc đặt lại 2FA sẽ đăng xuất người dùng khỏi tất cả các phiên và xóa thiết lập TOTP của họ. Họ sẽ cần thiết lập lại trong lần đăng nhập tiếp theo.',
      saveTheseCodes_title: 'Lưu các mã khôi phục này',
      scanQrCodeWithApp:
        'Quét mã QR này bằng một ứng dụng xác thực như Google Authenticator hoặc Authy.',
      security_title: 'Bảo mật',
      totpCode: 'Mã TOTP',
      totpOrRecoveryCode: 'Mã TOTP hoặc mã khôi phục',
      trustedDevices_title: 'Trình duyệt tin cậy',
      trustedDevicesHint:
        'Các trình duyệt đã được đánh dấu là tin cậy sẽ bỏ qua yếu tố thứ hai trong 30 ngày. Hãy thu hồi những trình duyệt mà bạn không còn nhận ra.',
      twoFactor_enabled: 'Xác thực hai yếu tố đã được bật.',
      twoFactor_intro:
        'Tăng thêm một lớp bảo mật cho tài khoản của bạn bằng mã dùng một lần dựa trên thời gian từ ứng dụng xác thực.',
      ...
      openBoardActions: 'Mở thao tác với bảng',
      openBoard_title: 'Mở bảng',
      openCardActions: 'Mở thao tác với thẻ',
      openListActions: 'Mở thao tác với danh sách',
      openNotifications: 'Mở thông báo',
      openProjectActions: 'Mở thao tác với dự án',
      openProjectSettings: 'Mở cài đặt dự án',
      ...
      showHiddenProjects: 'Hiển thị dự án đã ẩn',
    ...
    action: {
      ...
      disable2fa: 'Tắt 2FA',
      disableEditMode: 'Tắt chế độ chỉnh sửa',
      ...
      emptyTrash_title: 'Dọn sạch Thùng rác',
      enable2fa: 'Bật 2FA',
      enableEditMode: 'Bật chế độ chỉnh sửa',
      filterByCurrentUser: 'Lọc theo người dùng hiện tại',
      goBack: 'Quay lại',
      hideHiddenProjects: 'Không hiển thị dự án đã ẩn',
      hideProjectList: 'Ẩn danh sách dự án',
      import: 'Nhập',
      join: 'Tham gia',
      leave: 'Rời khỏi',
      ...
      showLess: 'Ẩn bớt',
      showMore: 'Xem thêm',
      showProjectList: 'Hiển thị danh sách dự án',
      sortList_title: 'Sắp xếp Danh sách',
      start: 'Bắt đầu',
      stayLoggedIn: 'Duy trì đăng nhập',
      stop: 'Dừng',
      subscribe: 'Đăng ký theo dõi',
      switchToGridProjectsView: 'Hiển thị dự án dạng lưới',
      switchToGridView: 'Chuyển sang chế độ xem lưới',
      switchToGroupedProjectsView: 'Hiển thị dự án theo nhóm',
      switchToKanbanView: 'Chuyển sang chế độ xem Kanban',
      switchToListView: 'Chuyển sang chế độ xem danh sách',
