...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Добавяне на услуга за известия',
      ...
      autoLogout_10m: 'След 10 минути',
      autoLogout_12h: 'След 12 часа',
      autoLogout_2m: 'След 2 минути',
      autoLogout_30m: 'След 30 минути',
      autoLogout_5m: 'След 5 минути',
      autoLogout_never: 'Никога',
      autoLogoutWarning_body:
        'Ще бъдете изведени от системата след {{seconds}} сек. поради неактивност.',
      autoLogoutWarning_title: 'Скоро ще бъдете изведени от системата',
      background: 'Фон',
      ...
      color: 'Цвят',
      comments: 'Коментари',
      confirmCodesSaved: 'Запазих тези кодове на сигурно място.',
      ...
      proFeatureDashboard: '✨ Едно табло за управление за всички проекти',
      proFeatureExport: '✨ Карти като PDF за вашите отчети',
      proFeatureMobile: '✨ PLANKA на телефон и таблет',
      proFeatureSso: '✨ Вход с фирмената ви директория (SSO)',
      proFeatureThemes: '✨ Пет теми и ваш собствен акцентен цвят',
      proFeatureTimeline: '✨ Времева линия: цяла година на една ос',
      proTrialSelfHosted: '✨ Изпробвайте PLANKA Pro 30 дни на вашия сървър',
      ...
      disable2fa_title: 'Деактивиране на двуфакторното удостоверяване',
      disable2faWarning:
        'Ще трябва да потвърдите текущата си парола и TOTP код. Съществуващите сесии остават активни.',
      display: 'Показване',
      ...
      enable2fa_title: 'Активиране на двуфакторно удостоверяване',
      enabledOn: 'Активирано на {{date}}',
      enterCardTitle: 'Въведете заглавие на картата...',
      enterCodeFromApp: 'Въведете 6-цифрения код от вашето приложение за удостоверяване.',
      enterDescription: 'Въведете описание...',
      enterFilename: 'Въведете име на файла',
      enterListTitle: 'Въведете заглавие на списък...',
      enterPasswordToContinue: 'Потвърдете текущата си парола, за да продължите.',
      enterTaskDescription: 'Въведете описание на задачата...',
      enterTotpOrRecoveryCode:
        'Въведете 6-цифрения код от вашето приложение за удостоверяване или един от вашите кодове за възстановяване (xxxxx-xxxxx).',
      events: 'Събития',
      ...
      invalidTotpCode: 'Невалиден TOTP код или код за възстановяване',
      kanban: 'Канбан',
      labels: 'Етикети',
      language: 'Език',
      ...
      noTrustedDevices: 'Няма доверени устройства.',
      ...
      openBoardActions: 'Отваряне на действия с табло',
      openBoard_title: 'Отворете табло',
      openCardActions: 'Отваряне на действия с карта',
      openListActions: 'Отваряне на действия със списък',
      openNotifications: 'Отваряне на уведомления',
      openProjectActions: 'Отваряне на действия с проект',
      openProjectSettings: 'Отваряне на настройките на проекта',
      optional_inline: 'по желание',
      orEnterSecretManually: 'Или въведете този таен ключ ръчно:',
      ...
      recoveryCodesExhausted:
        'Всички кодове за възстановяване са използвани. Генерирайте нов набор, за да имате резервен вариант, в случай че загубите достъп до приложението си за удостоверяване.',
      recoveryCodesIntro:
        'Съхранявайте тези кодове на сигурно място — всеки може да бъде използван веднъж, ако загубите достъп до приложението си за удостоверяване.',
      recoveryCodesLow_one:
        'Остава само {{count}} код за възстановяване. Препоръчително е скоро да ги регенерирате.',
      recoveryCodesLow_other:
        'Остават само {{count}} кода за възстановяване. Препоръчително е скоро да ги регенерирате.',
      referenceDataAndKnowledgeStorage: 'Съхранение на референтни данни и знания.',
      regenerateApiKey_title: 'Регенериране на API ключ',
      regenerateRecoveryCodes_title: 'Регенериране на кодовете за възстановяване',
      regenerateRecoveryCodesIntro:
        'Генерирането на нови кодове ще направи невалидни всички съществуващи кодове за възстановяване.',
      ...
      reset2fa_title: 'Нулиране на 2FA',
      reset2faWarning:
        'Нулирането на 2FA извежда потребителя от всички сесии и премахва неговата TOTP настройка. Той ще трябва да я настрои отново при следващото влизане.',
      role: 'Роля',
      saveTheseCodes_title: 'Запазете тези кодове за възстановяване',
      saveThisKeyItWillNotBeShownAgain: 'Запазете този ключ — няма да бъде показан отново!',
      scanQrCodeWithApp:
        'Сканирайте този QR код с приложение за удостоверяване като Google Authenticator или Authy.',
      ...
      showHiddenProjects: 'Показване на скритите проекти',
      ...
      title: 'Заглавие',
      totpCode: 'TOTP код',
      totpOrRecoveryCode: 'TOTP код или код за възстановяване',
      trash: 'Кошче',
      trashHasBeenSuccessfullyEmptied: 'Кошчето беше успешно изпразнено.',
      trustedDevices_title: 'Доверени браузъри',
      trustedDevicesHint:
        'Браузърите, отбелязани като доверени, пропускат втория фактор за 30 дни. Отнемете достъпа на всички, които вече не разпознавате.',
      turnOffRecentCardHighlighting: 'Изключване на подчертаването на скорошни карти',
      twoFactor_enabled: 'Двуфакторното удостоверяване е активирано.',
      twoFactor_intro:
        'Добавете допълнително ниво на сигурност към акаунта си, като използвате базиран на времето еднократен код от приложение за удостоверяване.',
    ...
    action: {
      ...
      disableEditMode: 'Изключване на режима на редактиране',
      ...
      enableEditMode: 'Включване на режима на редактиране',
      filterByCurrentUser: 'Филтриране по текущ потребител',
      goBack: 'Назад',
      hideHiddenProjects: 'Скриване на скритите проекти',
      hideProjectList: 'Скриване на списъка с проекти',
      import: 'Импортиране',
      join: 'Присъединяване',
      leave: 'Напускане',
      leaveBoard: 'Напускане на дъската',
      leaveProject: 'Напускане на проекта',
      logOutNow: 'Излезте сега',
      ...
      regenerateRecoveryCodes: 'Регенериране на кодовете за възстановяване',
      remove: 'Премахване',
      ...
      showProjectList: 'Показване на списъка с проекти',
      sortList_title: 'Списък за сортиране',
      start: 'Старт',
      stayLoggedIn: 'Останете в системата',
      stop: 'Стоп',
      subscribe: 'Абонирайте се',
      switchToGridProjectsView: 'Показване на проектите като мрежа',
      switchToGridView: 'Превключване към изглед Мрежа',
      switchToGroupedProjectsView: 'Показване на проектите по групи',
      switchToKanbanView: 'Превключване към изглед Канбан',
      switchToListView: 'Превключване към изглед Списък',
