...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Adicionar serviço de notificação',
      ...
      autoLogout: 'Fim de sessão automático',
      autoLogout_10m: 'Após 10 minutos',
      autoLogout_12h: 'Após 12 horas',
      autoLogout_2m: 'Após 2 minutos',
      autoLogout_30m: 'Após 30 minutos',
      autoLogout_5m: 'Após 5 minutos',
      autoLogout_never: 'Nunca',
      autoLogoutWarning_body: 'A sua sessão será terminada em {{seconds}}s por inatividade.',
      autoLogoutWarning_title: 'A sua sessão será terminada em breve',
      background: 'Fundo',
      ...
      confirmCodesSaved: 'Guardei estes códigos num local seguro.',
      ...
      disable2fa_title: 'Desativar autenticação de dois fatores',
      disable2faWarning:
        'Terá de confirmar a sua palavra-passe atual e um código TOTP. As sessões existentes permanecem iniciadas.',
      display: 'Exibir',
      ...
      enable2fa_title: 'Ativar autenticação de dois fatores',
      enabledOn: 'Ativada em {{date}}',
      enterCardTitle: 'Introduza o título do cartão...',
      enterCodeFromApp: 'Introduza o código de 6 dígitos da sua aplicação de autenticação.',
      ...
      enterPasswordToContinue: 'Confirme a sua palavra-passe atual para continuar.',
      enterTaskDescription: 'Introduza a descrição da tarefa...',
      enterTotpOrRecoveryCode:
        'Introduza o código de 6 dígitos da sua aplicação de autenticação ou um dos seus códigos de recuperação (xxxxx-xxxxx).',
      events: 'Eventos',
      ...
      invalidTotpCode: 'Código TOTP ou de recuperação inválido',
      kanban: 'Kanban',
      labels: 'Etiquetas',
      language: 'Idioma',
      ...
      noTrustedDevices: 'Nenhum dispositivo de confiança.',
      ...
      openBoardActions: 'Abrir ações do quadro',
      openBoard_title: 'Abrir quadro',
      openCardActions: 'Abrir ações do cartão',
      openListActions: 'Abrir ações da lista',
      openNotifications: 'Abrir notificações',
      openProjectActions: 'Abrir ações do projeto',
      openProjectSettings: 'Abrir configurações do projeto',
      optional_inline: 'opcional',
      orEnterSecretManually: 'Ou introduza esta chave secreta manualmente:',
      ...
      private: 'Privado',
      proFeatureDashboard: '✨ Um painel único para todos os seus projetos',
      proFeatureExport: '✨ Cartões em PDF para os seus relatórios',
      proFeatureMobile: '✨ O PLANKA em telemóveis e tablets',
      proFeatureSso: '✨ Início de sessão com o diretório da sua empresa (SSO)',
      proFeatureThemes: '✨ Cinco temas e a sua própria cor de destaque',
      proFeatureTimeline: '✨ Cronologia: um ano inteiro num só eixo',
      proTrialSelfHosted: '✨ Experimente o PLANKA Pro durante 30 dias no seu próprio servidor',
      project: 'Projeto',
      projectNotFound_title: 'Projeto não encontrado',
      projectOwner: 'Proprietário do projeto',
      recoveryCodesExhausted:
        'Todos os códigos de recuperação foram utilizados. Gere um novo conjunto para manter uma alternativa caso perca o acesso à sua aplicação de autenticação.',
      recoveryCodesIntro:
        'Guarde estes códigos num local seguro — cada um pode ser utilizado uma vez caso perca o acesso à sua aplicação de autenticação.',
      recoveryCodesLow_many:
        'Restam apenas {{count}} de códigos de recuperação. Considere gerar novos em breve.',
      recoveryCodesLow_one:
        'Resta apenas {{count}} código de recuperação. Considere gerar novos em breve.',
      recoveryCodesLow_other:
        'Restam apenas {{count}} códigos de recuperação. Considere gerar novos em breve.',
      ...
      regenerateRecoveryCodes_title: 'Regenerar códigos de recuperação',
      regenerateRecoveryCodesIntro:
        'Gerar novos códigos invalidará todos os códigos de recuperação existentes.',
      ...
      reset2fa_title: 'Repor 2FA',
      reset2faWarning:
        'Repor a 2FA termina todas as sessões do utilizador e remove a sua configuração TOTP. O utilizador terá de a configurar novamente no próximo início de sessão.',
      role: 'Função',
      saveTheseCodes_title: 'Guardar estes códigos de recuperação',
      saveThisKeyItWillNotBeShownAgain: 'Guarde esta chave — não será mostrada novamente!',
      scanQrCodeWithApp:
        'Leia este código QR com uma aplicação de autenticação, como o Google Authenticator ou o Authy.',
      ...
      totpOrRecoveryCode: 'Código TOTP ou de recuperação',
      trash: 'Lixo',
      trashHasBeenSuccessfullyEmptied: 'O lixo foi esvaziado com sucesso.',
      trustedDevices_title: 'Navegadores de confiança',
      trustedDevicesHint:
        'Os navegadores marcados como de confiança dispensam o segundo fator durante 30 dias. Revogue os que já não reconhecer.',
      turnOffRecentCardHighlighting: 'Desativar destaque de cartões recentes',
      twoFactor_enabled: 'A autenticação de dois fatores está ativada.',
      twoFactor_intro:
        'Adicione uma camada de segurança adicional à sua conta utilizando um código de uso único baseado no tempo, gerado por uma aplicação de autenticação.',
    ...
    action: {
      ...
      filterByCurrentUser: 'Filtrar pelo utilizador atual',
      goBack: 'Voltar',
      hideHiddenProjects: 'Ocultar projetos ocultos',
      hideProjectList: 'Ocultar lista de projetos',
      import: 'Importar',
      join: 'Aderir',
      leave: 'Sair',
      ...
      logOutNow: 'Terminar sessão agora',
      ...
      showProjectList: 'Mostrar lista de projetos',
      sortList_title: 'Ordenar lista',
      start: 'Iniciar',
      stayLoggedIn: 'Manter sessão iniciada',
      stop: 'Parar',
      subscribe: 'Subscrever',
      switchToGridProjectsView: 'Mostrar projetos em grelha',
      switchToGridView: 'Mudar para vista de grelha',
      switchToGroupedProjectsView: 'Mostrar projetos agrupados',
      switchToKanbanView: 'Mudar para vista Kanban',
      switchToListView: 'Mudar para vista de lista',
