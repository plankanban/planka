  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeactivateThisUser:
        'Estàs segur que vols desactivar aquest usuari?',
      ...
      clickHereOrRefreshPageToUpdate: '<0>Fes clic aquí</0> o actualitza la pàgina per actualitzar.',
      ...
      uploadFailedNotEnoughStorageSpace:
        'Error en pujar: No hi ha prou espai d\'emmagatzematge.',
      ...
      userRemovedUserFromCard: '<0>{{actorUser}}</0> ha eliminat {{removedUser}} de <4>{{card}}</4>',
      userRemovedUserFromThisCard: '<0>{{actorUser}}</0> ha eliminat {{removedUser}} d\'aquesta targeta',
