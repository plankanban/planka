...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Afegir servei de notificació',
      ...
      autoLogout: 'Tancament automàtic de sessió',
      autoLogoutWarning_body: "Se't tancarà la sessió en {{seconds}}s per inactivitat.",
      autoLogoutWarning_title: "Se't tancarà la sessió aviat",
      autoLogout_10m: 'Després de 10 minuts',
      autoLogout_12h: 'Després de 12 hores',
      autoLogout_2m: 'Després de 2 minuts',
      autoLogout_30m: 'Després de 30 minuts',
      autoLogout_5m: 'Després de 5 minuts',
      autoLogout_never: 'Mai',
      background: 'Fons',
      ...
      color: 'Color',
      comments: 'Comentaris',
      confirmCodesSaved: 'He desat aquests codis en un lloc segur.',
      ...
      disable2faWarning:
        'Hauràs de confirmar la contrasenya actual i un codi TOTP. Les sessions existents es mantindran iniciades.',
      disable2fa_title: "Desactivar l'autenticació de dos factors",
      display: 'Mostrar',
      ...
      enable2fa_title: "Activar l'autenticació de dos factors",
      enabledOn: 'Activat el {{date}}',
      enterCardTitle: 'Introdueix el títol de la targeta...',
      enterCodeFromApp: "Introdueix el codi de 6 dígits de la teva aplicació d'autenticació.",
      ...
      enterPasswordToContinue: 'Confirma la contrasenya actual per continuar.',
      enterTaskDescription: 'Introdueix la descripció de la tasca...',
      enterTotpOrRecoveryCode:
        "Introdueix el codi de 6 dígits de la teva aplicació d'autenticació, o un dels teus codis de recuperació (xxxxx-xxxxx).",
      ...
      invalidTotpCode: 'Codi TOTP o de recuperació no vàlid',
      kanban: 'Kanban',
      labels: 'Etiquetes',
      language: 'Idioma',
      lastUsed: 'Últim ús',
      ...
      noTrustedDevices: 'No hi ha dispositius de confiança.',
      ...
      openBoardActions: 'Obrir accions del tauler',
      openBoard_title: 'Obrir tauler',
      openCardActions: 'Obrir accions de la targeta',
      openListActions: 'Obrir accions de la llista',
      openNotifications: 'Obrir notificacions',
      openProjectActions: 'Obrir accions del projecte',
      openProjectSettings: 'Obrir configuració del projecte',
      optional_inline: 'opcional',
      orEnterSecretManually: 'O introdueix aquesta clau secreta manualment:',
      ...
      private: 'Privat',
      proFeatureDashboard: '✨ Un únic panell per a tots els projectes',
      proFeatureExport: '✨ Targetes en PDF per als vostres informes',
      proFeatureMobile: '✨ PLANKA al mòbil i a la tauleta',
      proFeatureSso: '✨ Inici de sessió amb el directori de la vostra empresa (SSO)',
      proFeatureThemes: "✨ Cinc temes i el vostre color d'accent",
      proFeatureTimeline: '✨ Línia de temps: tot un any en un sol eix',
      proTrialSelfHosted: '✨ Proveu PLANKA Pro durant 30 dies al vostre propi servidor',
      project: 'Projecte',
      projectNotFound_title: "No s'ha trobat el projecte",
      projectOwner: 'Propietari del projecte',
      recoveryCodesExhausted:
        "S'han utilitzat tots els codis de recuperació. Regenera'n un conjunt nou per mantenir una alternativa en cas que perdis l'aplicació d'autenticació.",
      recoveryCodesIntro:
        "Desa aquests codis en un lloc segur — cadascun es pot utilitzar una vegada si perds l'accés a la teva aplicació d'autenticació.",
      recoveryCodesLow_many:
        'Només queden {{count}} de codis de recuperació. Considera regenerar-los aviat.',
      recoveryCodesLow_one:
        'Només queda {{count}} codi de recuperació. Considera regenerar-los aviat.',
      recoveryCodesLow_other:
        'Només queden {{count}} codis de recuperació. Considera regenerar-los aviat.',
      ...
      regenerateRecoveryCodesIntro:
        'Si generes codis nous, tots els codis de recuperació existents deixaran de ser vàlids.',
      regenerateRecoveryCodes_title: 'Regenerar els codis de recuperació',
      ...
      reset2faWarning:
        "En restablir la 2FA es tanquen totes les sessions de l'usuari i s'elimina la seva configuració TOTP. Haurà de tornar a configurar-la en el pròxim inici de sessió.",
      reset2fa_title: 'Restablir 2FA',
      role: 'Rol',
      saveTheseCodes_title: 'Desar aquests codis de recuperació',
      saveThisKeyItWillNotBeShownAgain: 'Desa aquesta clau, no es tornarà a mostrar!',
      scanQrCodeWithApp:
        "Escaneja aquest codi QR amb una aplicació d'autenticació com Google Authenticator o Authy.",
      ...
      showHiddenProjects: 'Mostrar projectes ocults',
      ...
      title: 'Títol',
      totpCode: 'Codi TOTP',
      totpOrRecoveryCode: 'Codi TOTP o de recuperació',
      trash: 'Paperera',
      trashHasBeenSuccessfullyEmptied: "La paperera s'ha buidat correctament.",
      trustedDevicesHint:
        'Els navegadors de confiança ometen el segon factor durant 30 dies. Revoca els que ja no reconeguis.',
      trustedDevices_title: 'Navegadors de confiança',
      ...
      twoFactor_enabled: "L'autenticació de dos factors està activada.",
      twoFactor_intro:
        "Afegeix una capa de seguretat addicional al teu compte amb un codi d'un sol ús basat en el temps generat per una aplicació d'autenticació.",
    ...
    action: {
      ...
      disableEditMode: "Desactivar el mode d'edició",
      ...
      enableEditMode: "Activar el mode d'edició",
      filterByCurrentUser: 'Filtrar per usuari actual',
      goBack: 'Enrere',
      hideHiddenProjects: 'Amagar projectes ocults',
      hideProjectList: 'Ocultar la llista de projectes',
      import: 'Importar',
      join: 'Unir-se',
      leave: 'Abandonar',
      leaveBoard: 'Abandonar tauler',
      leaveProject: 'Abandonar projecte',
      logOutNow: 'Tancar sessió ara',
      ...
      regenerateRecoveryCodes: 'Regenerar codis de recuperació',
      remove: 'Eliminar',
      ...
      showProjectList: 'Mostrar la llista de projectes',
      sortList_title: 'Ordenar llista',
      start: 'Iniciar',
      stayLoggedIn: 'Mantenir la sessió iniciada',
      stop: 'Aturar',
      subscribe: "Subscriure's",
      switchToGridProjectsView: 'Mostrar projectes en graella',
      switchToGridView: 'Canviar a la vista de graella',
      switchToGroupedProjectsView: 'Mostrar projectes agrupats',
      switchToKanbanView: 'Canviar a la vista Kanban',
      switchToListView: 'Canviar a la vista de llista',
