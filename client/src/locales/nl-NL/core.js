...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Meldingsservice toevoegen',
      ...
      autoLogout_10m: 'Na 10 minuten',
      autoLogout_12h: 'Na 12 uur',
      autoLogout_2m: 'Na 2 minuten',
      autoLogout_30m: 'Na 30 minuten',
      autoLogout_5m: 'Na 5 minuten',
      autoLogout_never: 'Nooit',
      autoLogoutWarning_body: 'U wordt over {{seconds}}s uitgelogd wegens inactiviteit.',
      autoLogoutWarning_title: 'U wordt binnenkort uitgelogd',
      ...
      confirmCodesSaved: 'Ik heb deze codes op een veilige plek bewaard.',
      ...
      disable2fa_title: 'Tweefactorauthenticatie uitschakelen',
      disable2faWarning:
        'U moet uw huidige wachtwoord en een TOTP-code bevestigen. Bestaande sessies blijven ingelogd.',
      enable2fa_title: 'Tweefactorauthenticatie inschakelen',
      enabledOn: 'Ingeschakeld op {{date}}',
      enterCodeFromApp: 'Voer de 6-cijferige code uit uw authenticator-app in.',
      enterPasswordToContinue: 'Bevestig uw huidige wachtwoord om door te gaan.',
      enterTotpOrRecoveryCode:
        'Voer de 6-cijferige code uit uw authenticator-app in, of een van uw herstelcodes (xxxxx-xxxxx).',
      expires: 'Verloopt',
      invalidTotpCode: 'Ongeldige TOTP- of herstelcode',
      lastUsed: 'Laatst gebruikt',
      never: 'Nooit',
      noTrustedDevices: 'Geen vertrouwde apparaten.',
      openBoardActions: 'Bordacties openen',
      openCardActions: 'Kaartacties openen',
      openListActions: 'Lijstacties openen',
      openNotifications: 'Meldingen openen',
      openProjectActions: 'Projectacties openen',
      openProjectSettings: 'Projectinstellingen openen',
      orEnterSecretManually: 'Of voer deze geheime sleutel handmatig in:',
      recoveryCodesExhausted:
        'Alle herstelcodes zijn gebruikt. Genereer een nieuwe set om een terugvaloptie te hebben als u geen toegang meer heeft tot uw authenticator-app.',
      recoveryCodesIntro:
        'Bewaar deze codes op een veilige plek — elke code kan één keer worden gebruikt als u geen toegang meer heeft tot uw authenticator-app.',
      recoveryCodesLow_one:
        'Nog maar {{count}} herstelcode over. Overweeg binnenkort nieuwe te genereren.',
      recoveryCodesLow_other:
        'Nog maar {{count}} herstelcodes over. Overweeg binnenkort nieuwe te genereren.',
      regenerateRecoveryCodes_title: 'Herstelcodes opnieuw genereren',
      regenerateRecoveryCodesIntro:
        'Bij het genereren van nieuwe codes worden alle bestaande herstelcodes ongeldig.',
      reset2fa_title: '2FA resetten',
      reset2faWarning:
        'Bij het resetten van 2FA wordt de gebruiker uit alle sessies uitgelogd en wordt de TOTP-instelling verwijderd. De gebruiker moet deze bij de volgende keer inloggen opnieuw instellen.',
      saveTheseCodes_title: 'Bewaar deze herstelcodes',
      scanQrCodeWithApp:
        'Scan deze QR-code met een authenticator-app zoals Google Authenticator of Authy.',
      security_title: 'Beveiliging',
      showHiddenProjects: 'Verborgen projecten tonen',
      totpCode: 'TOTP-code',
      totpOrRecoveryCode: 'TOTP- of herstelcode',
      trustedDevices_title: 'Vertrouwde browsers',
      trustedDevicesHint:
        'Browsers die als vertrouwd zijn gemarkeerd, slaan de tweede factor 30 dagen over. Trek de browsers in die u niet meer herkent.',
      twoFactor_enabled: 'Tweefactorauthenticatie is ingeschakeld.',
      twoFactor_intro:
        'Voeg met een tijdgebonden eenmalige code uit een authenticator-app een extra beveiligingslaag toe aan uw account.',
      ...
      private: 'Privé',
      proFeatureDashboard: '✨ Eén dashboard voor al uw projecten',
      proFeatureExport: '✨ Kaarten als PDF voor uw rapportages',
      proFeatureMobile: '✨ PLANKA op telefoon en tablet',
      proFeatureSso: '✨ Inloggen met uw bedrijfsdirectory (SSO)',
      proFeatureThemes: "✨ Vijf thema's en uw eigen accentkleur",
      proFeatureTimeline: '✨ Tijdlijn: het hele jaar op één as',
      proTrialSelfHosted: '✨ Probeer PLANKA Pro 30 dagen op uw eigen server',
      project: 'Project',
    ...
    action: {
      ...
      disableEditMode: 'Bewerkingsmodus uitschakelen',
      ...
      enableEditMode: 'Bewerkingsmodus inschakelen',
      filterByCurrentUser: 'Filteren op huidige gebruiker',
      goBack: 'Terug',
      hideHiddenProjects: 'Verborgen projecten verbergen',
      hideProjectList: 'Projectlijst verbergen',
      import: 'Importeren',
      join: 'Deelnemen',
      leave: 'Verlaten',
      ...
      showMore: 'Meer tonen',
      showProjectList: 'Projectlijst tonen',
      sortList_title: 'Lijst sorteren',
      start: 'Start',
      stayLoggedIn: 'Ingelogd blijven',
      stop: 'Stop',
      subscribe: 'Abonneren',
      switchToGridProjectsView: 'Projecten als raster tonen',
      switchToGridView: 'Naar rasterweergave wisselen',
      switchToGroupedProjectsView: 'Projecten gegroepeerd tonen',
      switchToKanbanView: 'Naar kanbanweergave wisselen',
      switchToListView: 'Naar lijstweergave wisselen',
