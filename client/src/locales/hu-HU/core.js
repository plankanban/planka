...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Értesítési szolgáltatás hozzáadása',
      ...
      autoLogout_10m: '10 perc után',
      autoLogout_12h: '12 óra után',
      autoLogout_2m: '2 perc után',
      autoLogout_30m: '30 perc után',
      autoLogout_5m: '5 perc után',
      autoLogout_never: 'Soha',
      autoLogoutWarning_body: 'Inaktivitás miatt {{seconds}} másodperc múlva kijelentkeztetjük.',
      autoLogoutWarning_title: 'Hamarosan kijelentkeztetjük',
      background: 'Háttér',
      ...
      confirmCodesSaved: 'Biztonságos helyre mentettem ezeket a kódokat.',
      ...
      proFeatureDashboard: '✨ Egyetlen irányítópult az összes projektedhez',
      proFeatureExport: '✨ Kártyák PDF-ben a jelentéseidhez',
      proFeatureMobile: '✨ PLANKA telefonon és táblagépen',
      proFeatureSso: '✨ Bejelentkezés a céges címtárral (SSO)',
      proFeatureThemes: '✨ Öt téma és saját kiemelőszín',
      proFeatureTimeline: '✨ Idővonal: egy teljes év egyetlen tengelyen',
      proTrialSelfHosted: '✨ Próbáld ki a PLANKA Pro-t 30 napig a saját szervereden',
      dismissProBannerFor30Days: 'Bezárás 30 napra',
      customerPanel_title: 'Ügyfélpanel',
      dangerZone_title: 'Veszélyzóna',
      disable2fa_title: 'Kétfaktoros hitelesítés kikapcsolása',
      disable2faWarning:
        'Meg kell erősítenie a jelenlegi jelszavát és egy TOTP-kódot. A meglévő munkamenetek bejelentkezve maradnak.',
      enable2fa_title: 'Kétfaktoros hitelesítés bekapcsolása',
      enabledOn: 'Bekapcsolva: {{date}}',
      enterCodeFromApp: 'Adja meg a hitelesítő alkalmazásában megjelenő 6 jegyű kódot.',
      enterPasswordToContinue: 'A folytatáshoz erősítse meg a jelenlegi jelszavát.',
      enterTotpOrRecoveryCode:
        'Adja meg a hitelesítő alkalmazásában megjelenő 6 jegyű kódot vagy az egyik helyreállítási kódját (xxxxx-xxxxx).',
      expires: 'Lejárat',
      invalidTotpCode: 'Érvénytelen TOTP- vagy helyreállítási kód',
      lastUsed: 'Utoljára használva',
      never: 'Soha',
      noTrustedDevices: 'Nincsenek megbízható eszközök.',
      openBoardActions: 'Tábla műveletek megnyitása',
      openCardActions: 'Kártya műveletek megnyitása',
      openListActions: 'Lista műveletek megnyitása',
      openNotifications: 'Értesítések megnyitása',
      openProjectActions: 'Projekt műveletek megnyitása',
      openProjectSettings: 'Projekt beállításainak megnyitása',
      orEnterSecretManually: 'Vagy adja meg kézzel ezt a titkos kulcsot:',
      recoveryCodesExhausted:
        'Az összes helyreállítási kódot felhasználta. Generáljon új kódokat, hogy legyen tartaléka, ha elveszíti a hitelesítő alkalmazását.',
      recoveryCodesIntro:
        'Tárolja ezeket a kódokat biztonságos helyen — mindegyik egyszer használható fel, ha elveszíti a hozzáférést a hitelesítő alkalmazásához.',
      recoveryCodesLow_one:
        'Már csak {{count}} helyreállítási kód maradt. Érdemes hamarosan újragenerálni a kódokat.',
      recoveryCodesLow_other:
        'Már csak {{count}} helyreállítási kód maradt. Érdemes hamarosan újragenerálni a kódokat.',
      regenerateRecoveryCodes_title: 'Helyreállítási kódok újragenerálása',
      regenerateRecoveryCodesIntro:
        'Új kódok generálásával az összes meglévő helyreállítási kód érvénytelenné válik.',
      reset2fa_title: '2FA visszaállítása',
      reset2faWarning:
        'A 2FA visszaállítása kijelentkezteti a felhasználót az összes munkamenetből, és eltávolítja a TOTP-beállítását. A következő bejelentkezéskor újra be kell állítania.',
      saveTheseCodes_title: 'Helyreállítási kódok mentése',
      scanQrCodeWithApp:
        'Olvassa be ezt a QR-kódot egy hitelesítő alkalmazással, például a Google Authenticatorral vagy az Authyval.',
      security_title: 'Biztonság',
      showHiddenProjects: 'Rejtett projektek megjelenítése',
      totpCode: 'TOTP-kód',
      totpOrRecoveryCode: 'TOTP- vagy helyreállítási kód',
      trustedDevices_title: 'Megbízható böngészők',
      trustedDevicesHint:
        'A megbízhatónak jelölt böngészőknél 30 napig nincs szükség a második faktorra. Vonja vissza azokat, amelyeket már nem ismer fel.',
      twoFactor_enabled: 'A kétfaktoros hitelesítés be van kapcsolva.',
      twoFactor_intro:
        'Növelje fiókja biztonságát egy hitelesítő alkalmazás által generált, időalapú egyszeri kóddal.',
    ...
    action: {
      ...
      disableEditMode: 'Szerkesztési mód kikapcsolása',
      ...
      enableEditMode: 'Szerkesztési mód bekapcsolása',
      filterByCurrentUser: 'Szűrés a jelenlegi felhasználó alapján',
      goBack: 'Vissza',
      hideHiddenProjects: 'Rejtett projektek elrejtése',
      hideProjectList: 'Projektlista elrejtése',
      import: 'Importálás',
      join: 'Csatlakozás',
      leave: 'Kilépés',
      ...
      regenerateRecoveryCodes: 'Helyreállítási kódok újragenerálása',
      remove: 'Eltávolítás',
      ...
      returnToProjects: 'Vissza a projektekhez',
      revoke: 'Visszavonás',
      save: 'Mentés',
      ...
      showProjectList: 'Projektlista megjelenítése',
      sortList_title: 'Rendezés listában',
      start: 'Indítás',
      stayLoggedIn: 'Bejelentkezve maradok',
      stop: 'Megállítás',
      subscribe: 'Feliratkozás',
      switchToGridProjectsView: 'Projektek megjelenítése rácsban',
      switchToGridView: 'Váltás rács nézetre',
      switchToGroupedProjectsView: 'Projektek megjelenítése csoportosítva',
      switchToKanbanView: 'Váltás kanban nézetre',
      switchToListView: 'Váltás lista nézetre',
