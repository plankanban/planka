...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Pridať notifikačnú službu',
      ...
      openBoardActions: 'Otvoriť akcie tabule',
      openCardActions: 'Otvoriť akcie karty',
      openListActions: 'Otvoriť akcie zoznamu',
      openNotifications: 'Otvoriť oznámenia',
      openProjectActions: 'Otvoriť akcie projektu',
      openProjectSettings: 'Otvoriť nastavenia projektu',
      ...
      showHiddenProjects: 'Zobraziť skryté projekty',
      totpCode: 'Kód TOTP',
    ...
    action: {
      ...
      disableEditMode: 'Vypnúť režim úprav',
      ...
      enableEditMode: 'Zapnúť režim úprav',
      filterByCurrentUser: 'Filtrovať podľa aktuálneho používateľa',
      goBack: 'Späť',
      hideHiddenProjects: 'Nezobrazovať skryté projekty',
      hideProjectList: 'Skryť zoznam projektov',
      import: 'Importovať',
      join: 'Pripojiť sa',
      leave: 'Opustiť',
      ...
      returnToProjects: 'Vrátiť sa k projektom',
      revoke: 'Odvolať',
      save: 'Uložiť',
      ...
      showProjectList: 'Zobraziť zoznam projektov',
      sortList_title: 'Zoradiť zoznam',
      start: 'Start',
      stayLoggedIn: 'Zostať prihlásený',
      stop: 'Stop',
      subscribe: 'Odoberať',
      switchToGridProjectsView: 'Zobraziť projekty ako mriežku',
      switchToGridView: 'Prepnúť na zobrazenie mriežky',
      switchToGroupedProjectsView: 'Zobraziť projekty po skupinách',
      switchToKanbanView: 'Prepnúť na zobrazenie Kanban',
