...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Додај услугу обавештења',
      ...
      autoLogout_10m: 'После 10 минута',
      autoLogout_12h: 'После 12 сати',
      autoLogout_2m: 'После 2 минута',
      autoLogout_30m: 'После 30 минута',
      autoLogout_5m: 'После 5 минута',
      autoLogout_never: 'Никада',
      autoLogoutWarning_body: 'Због неактивности бићете одјављени за {{seconds}} сек.',
      autoLogoutWarning_title: 'Ускоро ћете бити одјављени',
      background: 'Позадина',
      ...
      color: 'Боја',
      comments: 'Коментари',
      confirmCodesSaved: 'Сачувао сам ове кодове на сигурном месту.',
      ...
      proFeatureDashboard: '✨ Једна контролна табла за све пројекте',
      proFeatureExport: '✨ Картице као PDF за ваше извештаје',
      proFeatureMobile: '✨ PLANKA на телефону и таблету',
      proFeatureSso: '✨ Пријава преко директоријума ваше компаније (SSO)',
      proFeatureThemes: '✨ Пет тема и ваша боја акцента',
      proFeatureTimeline: '✨ Временска линија: цела година на једној оси',
      proTrialSelfHosted: '✨ Испробајте PLANKA Pro 30 дана на сопственом серверу',
      dismissProBannerFor30Days: 'Затвори на 30 дана',
      customerPanel_title: 'Панел купца',
      dangerZone_title: 'Опасна зона',
      disable2fa_title: 'Онемогући двофакторску аутентификацију',
      disable2faWarning:
        'Мораћете да потврдите тренутну лозинку и TOTP код. Постојеће сесије остају активне.',
      enable2fa_title: 'Омогући двофакторску аутентификацију',
      enabledOn: 'Омогућено {{date}}',
      enterCodeFromApp: 'Унесите 6-цифрени код из ваше апликације за аутентификацију.',
      enterPasswordToContinue: 'Потврдите тренутну лозинку да бисте наставили.',
      enterTotpOrRecoveryCode:
        'Унесите 6-цифрени код из ваше апликације за аутентификацију или један од ваших кодова за опоравак (xxxxx-xxxxx).',
      expires: 'Истиче',
      invalidTotpCode: 'Неисправан TOTP код или код за опоравак',
      lastUsed: 'Последње коришћење',
      never: 'Никада',
      noTrustedDevices: 'Нема поузданих уређаја.',
      openBoardActions: 'Отвори радње над таблом',
      openCardActions: 'Отвори радње над картицом',
      openListActions: 'Отвори радње над списком',
      openNotifications: 'Отвори обавештења',
      openProjectActions: 'Отвори радње над пројектом',
      openProjectSettings: 'Отвори подешавања пројекта',
      orEnterSecretManually: 'Или ручно унесите овај тајни кључ:',
      recoveryCodesExhausted:
        'Сви кодови за опоравак су искоришћени. Регенеришите нови комплет да бисте задржали резервну опцију у случају да изгубите приступ апликацији за аутентификацију.',
      recoveryCodesIntro:
        'Чувајте ове кодове на сигурном месту — сваки се може искористити једном ако изгубите приступ апликацији за аутентификацију.',
      recoveryCodesLow_few:
        'Преостала су само {{count}} кода за опоравак. Препоручујемо да их ускоро регенеришете.',
      recoveryCodesLow_one:
        'Преостао је само {{count}} код за опоравак. Препоручујемо да их ускоро регенеришете.',
      recoveryCodesLow_other:
        'Преостало је само {{count}} кодова за опоравак. Препоручујемо да их ускоро регенеришете.',
      regenerateRecoveryCodes_title: 'Регенериши кодове за опоравак',
      regenerateRecoveryCodesIntro:
        'Генерисањем нових кодова сви постојећи кодови за опоравак постају неважећи.',
      reset2fa_title: 'Ресетуј 2FA',
      reset2faWarning:
        'Ресетовање 2FA одјављује корисника из свих сесија и уклања његово TOTP подешавање. Мораће да га поново подеси при следећој пријави.',
      saveTheseCodes_title: 'Сачувајте ове кодове за опоравак',
      scanQrCodeWithApp:
        'Скенирајте овај QR код апликацијом за аутентификацију као што је Google Authenticator или Authy.',
      security_title: 'Безбедност',
      showHiddenProjects: 'Прикажи скривене пројекте',
      totpCode: 'TOTP код',
      totpOrRecoveryCode: 'TOTP код или код за опоравак',
      trustedDevices_title: 'Поуздани веб прегледачи',
      trustedDevicesHint:
        'Веб прегледачи означени као поуздани прескачу други фактор 30 дана. Опозовите све које више не препознајете.',
      twoFactor_enabled: 'Двофакторска аутентификација је омогућена.',
      twoFactor_intro:
        'Заштитите свој налог додатним нивоом безбедности помоћу временски заснованог једнократног кода из апликације за аутентификацију.',
    ...
    action: {
      ...
      disable2fa: 'Онемогући 2FA',
      disableEditMode: 'Искључи режим уређивања',
      ...
      emptyTrash_title: 'Испразни корпу',
      enable2fa: 'Омогући 2FA',
      enableEditMode: 'Укључи режим уређивања',
      filterByCurrentUser: 'Филтрирај према тренутном кориснику',
      goBack: 'Назад',
      hideHiddenProjects: 'Сакриј скривене пројекте',
      hideProjectList: 'Сакриј листу пројеката',
      import: 'Увези',
      join: 'Придружи се',
      leave: 'Напусти',
      ...
      regenerateRecoveryCodes: 'Регенериши кодове за опоравак',
      remove: 'Уклони',
      ...
      reset2fa: 'Ресетуј 2FA',
      restoreToList: 'Врати у {{list}}',
      returnToBoard: 'Врати се на таблу',
      returnToProjects: 'Врати се на пројекте',
      revoke: 'Опозови',
      save: 'Сачувај',
      ...
      showProjectList: 'Прикажи листу пројеката',
      sortList_title: 'Сложи списак',
      start: 'Почни',
      stayLoggedIn: 'Остани пријављен',
      stop: 'Заустави',
      subscribe: 'Претплати се',
      switchToGridProjectsView: 'Прикажи пројекте као мрежу',
      switchToGridView: 'Пређи на приказ мреже',
      switchToGroupedProjectsView: 'Прикажи пројекте груписано',
      switchToKanbanView: 'Пређи на приказ канбана',
      switchToListView: 'Пређи на приказ списка',
