...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'إضافة خدمة إشعارات',
      ...
      autoLogout_10m: 'بعد 10 دقائق',
      autoLogout_12h: 'بعد 12 ساعة',
      autoLogout_2m: 'بعد دقيقتين',
      autoLogout_30m: 'بعد 30 دقيقة',
      autoLogout_5m: 'بعد 5 دقائق',
      autoLogout_never: 'أبداً',
      autoLogoutWarning_body: 'سيتم تسجيل خروجك خلال {{seconds}} ثانية بسبب عدم النشاط.',
      autoLogoutWarning_title: 'سيتم تسجيل خروجك قريباً',
      background: 'الخلفية',
      ...
      color: 'اللون',
      comments: 'التعليقات',
      confirmCodesSaved: 'لقد حفظت هذه الرموز في مكان آمن.',
      ...
      proFeatureDashboard: '✨ لوحة معلومات واحدة لجميع المشاريع',
      proFeatureExport: '✨ البطاقات بصيغة PDF لتقاريرك',
      proFeatureMobile: '✨ PLANKA على الهواتف والأجهزة اللوحية',
      proFeatureSso: '✨ تسجيل الدخول عبر دليل شركتك (SSO)',
      proFeatureThemes: '✨ خمس سمات ولون تمييز خاص بك',
      proFeatureTimeline: '✨ المخطط الزمني: سنة كاملة على محور واحد',
      proTrialSelfHosted: '✨ جرب PLANKA Pro لمدة 30 يومًا على خادمك الخاص',
      dismissProBannerFor30Days: 'إغلاق لمدة 30 يومًا',
      customerPanel_title: 'لوحة العملاء',
      dangerZone_title: 'منطقة الخطر',
      disable2fa_title: 'تعطيل المصادقة الثنائية',
      disable2faWarning:
        'ستحتاج إلى تأكيد كلمة المرور الحالية ورمز TOTP. ستبقى الجلسات الحالية مسجلة الدخول.',
      enable2fa_title: 'تفعيل المصادقة الثنائية',
      enabledOn: 'تم التفعيل في {{date}}',
      enterCodeFromApp: 'أدخل الرمز المكون من 6 أرقام من تطبيق المصادقة.',
      enterPasswordToContinue: 'أكد كلمة المرور الحالية للمتابعة.',
      enterTotpOrRecoveryCode:
        'أدخل الرمز المكون من 6 أرقام من تطبيق المصادقة، أو أحد رموز الاسترداد (xxxxx-xxxxx).',
      expires: 'انتهاء الصلاحية',
      invalidTotpCode: 'رمز TOTP أو رمز الاسترداد غير صالح',
      lastUsed: 'آخر استخدام',
      never: 'أبداً',
      noTrustedDevices: 'لا توجد أجهزة موثوقة.',
      orEnterSecretManually: 'أو أدخل هذا المفتاح السري يدوياً:',
      recoveryCodesExhausted:
        'تم استخدام جميع رموز الاسترداد. أعد إنشاء مجموعة جديدة للاحتفاظ ببديل في حال فقدت تطبيق المصادقة.',
      recoveryCodesIntro:
        'احفظ هذه الرموز في مكان آمن — يمكن استخدام كل رمز مرة واحدة في حال فقدت الوصول إلى تطبيق المصادقة.',
      recoveryCodesLow_zero: 'لم يتبق أي رمز استرداد. من الأفضل إعادة إنشائها قريباً.',
      recoveryCodesLow_one: 'لم يتبق سوى رمز استرداد واحد. من الأفضل إعادة إنشائه قريباً.',
      recoveryCodesLow_two: 'لم يتبق سوى رمزي استرداد. من الأفضل إعادة إنشائهما قريباً.',
      recoveryCodesLow_few: 'لم يتبق سوى {{count}} رموز استرداد. من الأفضل إعادة إنشائها قريباً.',
      recoveryCodesLow_many: 'لم يتبق سوى {{count}} رمز استرداد. من الأفضل إعادة إنشائها قريباً.',
      recoveryCodesLow_other: 'لم يتبق سوى {{count}} رمز استرداد. من الأفضل إعادة إنشائها قريباً.',
      regenerateRecoveryCodes_title: 'إعادة إنشاء رموز الاسترداد',
      regenerateRecoveryCodesIntro: 'إنشاء رموز جديدة سيبطل جميع رموز الاسترداد الحالية.',
      reset2fa_title: 'إعادة تعيين 2FA',
      reset2faWarning:
        'إعادة تعيين المصادقة الثنائية تسجل خروج المستخدم من جميع الجلسات وتزيل إعداد TOTP الخاص به. سيحتاج إلى إعداده مرة أخرى عند تسجيل الدخول التالي.',
      saveTheseCodes_title: 'حفظ رموز الاسترداد هذه',
      scanQrCodeWithApp: 'امسح رمز QR هذا باستخدام تطبيق مصادقة مثل Google Authenticator أو Authy.',
      security_title: 'الأمان',
      totpCode: 'رمز TOTP',
      totpOrRecoveryCode: 'رمز TOTP أو رمز الاسترداد',
      trustedDevices_title: 'المتصفحات الموثوقة',
      trustedDevicesHint:
        'المتصفحات التي تم وضع علامة موثوق عليها تتخطى العامل الثاني لمدة 30 يومًا. أبطل أي متصفح لم تعد تعرفه.',
      twoFactor_enabled: 'المصادقة الثنائية مفعلة.',
      twoFactor_intro:
        'أضف طبقة أمان إضافية إلى حسابك باستخدام رمز لمرة واحدة يعتمد على الوقت من تطبيق المصادقة.',
      ...
      openBoardActions: 'فتح إجراءات اللوحة',
      openBoard_title: 'فتح اللوحة',
      openCardActions: 'فتح إجراءات البطاقة',
      openListActions: 'فتح إجراءات القائمة',
      openNotifications: 'فتح الإشعارات',
      openProjectActions: 'فتح إجراءات المشروع',
      ...
      showHiddenProjects: 'عرض المشاريع المخفية',
    ...
    action: {
      ...
      disableEditMode: 'تعطيل وضع التعديل',
      dismissAll: 'رفض الكل',
      done: 'تم',
      download: 'تحميل',
      ...
      filterByCurrentUser: 'تصفية حسب المستخدم الحالي',
      goBack: 'رجوع',
      hideHiddenProjects: 'إخفاء المشاريع المخفية',
      hideProjectList: 'إخفاء قائمة المشاريع',
      import: 'استيراد',
      join: 'انضمام',
      leave: 'مغادرة',
      ...
      showLess: 'عرض أقل',
      showMore: 'عرض المزيد',
      showProjectList: 'عرض قائمة المشاريع',
      sortList_title: 'فرز القائمة',
      start: 'ابدأ',
      stayLoggedIn: 'البقاء متصلاً',
      stop: 'توقف',
      subscribe: 'اشترك',
      switchToGridProjectsView: 'عرض المشاريع كشبكة',
      switchToGridView: 'التبديل إلى عرض الشبكة',
      switchToGroupedProjectsView: 'عرض المشاريع مجمعة',
      switchToKanbanView: 'التبديل إلى عرض كانبان',
