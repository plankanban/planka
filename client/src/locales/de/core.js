...
export default {
  ...
  translation: {
    common: {
      ...
      project: 'Projekt',
      projectActions_title: 'Projekt Aktionen',
      projectNotFound_title: 'Projekt nicht gefunden',
      refreshPageToLoadLastDataAndReceiveUpdates:
        '<0>Seite aktualisieren</0> um die letzten Änderungen zu laden<br />und updates zu erhalten',
