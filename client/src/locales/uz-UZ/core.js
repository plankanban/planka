...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: "Bildirishnoma xizmatini qo'shish",
      ...
      autoLogout_10m: '10 daqiqadan keyin',
      autoLogout_12h: '12 soatdan keyin',
      autoLogout_2m: '2 daqiqadan keyin',
      autoLogout_30m: '30 daqiqadan keyin',
      autoLogout_5m: '5 daqiqadan keyin',
      autoLogout_never: 'Hech qachon',
      autoLogoutWarning_body:
        'Harakatsizlik tufayli {{seconds}} soniyadan keyin tizimdan chiqarilasiz.',
      autoLogoutWarning_title: 'Tez orada tizimdan chiqarilasiz',
      background: 'Orqa fon',
      ...
      color: 'Rang',
      comments: 'Izohlar',
      confirmCodesSaved: 'Men ushbu kodlarni xavfsiz joyda saqladim.',
      ...
      disable2fa_title: "Ikki faktorli autentifikatsiyani o'chirish",
      disable2faWarning:
        "Hozirgi parolingizni va TOTP kodini tasdiqlashingiz kerak bo'ladi. Mavjud sessiyalar tizimda qoladi.",
      enable2fa_title: 'Ikki faktorli autentifikatsiyani yoqish',
      enabledOn: '{{date}} da yoqilgan',
      enterCodeFromApp: 'Autentifikator ilovangizdagi 6 xonali kodni kiriting.',
      enterPasswordToContinue: 'Davom etish uchun hozirgi parolingizni tasdiqlang.',
      enterTotpOrRecoveryCode:
        'Autentifikator ilovangizdagi 6 xonali kodni yoki tiklash kodlaringizdan birini (xxxxx-xxxxx) kiriting.',
      expires: 'Amal qilish muddati',
      invalidTotpCode: "Noto'g'ri TOTP yoki tiklash kodi",
      lastUsed: 'Oxirgi foydalanilgan',
      never: 'Hech qachon',
      noTrustedDevices: "Ishonchli qurilmalar yo'q.",
      openBoardActions: 'Doska amallarini ochish',
      openCardActions: 'Karta amallarini ochish',
      openListActions: "Ro'yxat amallarini ochish",
      openNotifications: 'Bildirishnomalarni ochish',
      openProjectActions: 'Loyiha amallarini ochish',
      openProjectSettings: 'Loyiha sozlamalarini ochish',
      orEnterSecretManually: "Yoki ushbu maxfiy kalitni qo'lda kiriting:",
      recoveryCodesExhausted:
        "Barcha tiklash kodlari ishlatilgan. Autentifikator ilovangizni yo'qotgan taqdirda zaxira bo'lishi uchun yangi to'plam yarating.",
      recoveryCodesIntro:
        'Ushbu kodlarni xavfsiz joyda saqlang — autentifikator ilovangizga kira olmasangiz, har biridan bir marta foydalanish mumkin.',
      recoveryCodesLow_one:
        "Faqat {{count}} ta tiklash kodi qoldi. Tez orada yangilarini yaratishni o'ylab ko'ring.",
      recoveryCodesLow_other:
        "Faqat {{count}} ta tiklash kodi qoldi. Tez orada yangilarini yaratishni o'ylab ko'ring.",
      regenerateRecoveryCodes_title: 'Tiklash kodlarini qayta yaratish',
      regenerateRecoveryCodesIntro:
        "Yangi kodlar yaratilganda barcha mavjud tiklash kodlari bekor bo'ladi.",
      reset2fa_title: "2FA ni qayta o'rnatish",
      reset2faWarning:
        "2FA qayta o'rnatilganda foydalanuvchi barcha sessiyalardan chiqariladi va uning TOTP sozlamalari o'chiriladi. U keyingi kirishda uni qaytadan sozlashi kerak bo'ladi.",
      saveTheseCodes_title: 'Ushbu tiklash kodlarini saqlang',
      scanQrCodeWithApp:
        'Ushbu QR kodni Google Authenticator yoki Authy kabi autentifikator ilovasi yordamida skanerlang.',
      security_title: 'Xavfsizlik',
      showHiddenProjects: "Yashirilgan loyihalarni ko'rsatish",
      totpCode: 'TOTP kodi',
      totpOrRecoveryCode: 'TOTP yoki tiklash kodi',
      trustedDevices_title: 'Ishonchli brauzerlar',
      trustedDevicesHint:
        "Ishonchli deb belgilangan brauzerlar 30 kun davomida ikkinchi faktorni o'tkazib yuboradi. O'zingiz tanimaydigan brauzerlarni bekor qiling.",
      twoFactor_enabled: 'Ikki faktorli autentifikatsiya yoqilgan.',
      twoFactor_intro:
        "Autentifikator ilovasidagi vaqtga asoslangan bir martalik koddan foydalanib, hisobingizga qo'shimcha xavfsizlik qatlamini qo'shing.",
      ...
      private: 'Shaxsiy',
      proFeatureDashboard: '✨ Barcha loyihalar uchun yagona boshqaruv paneli',
      proFeatureExport: "✨ Hisobotlaringiz uchun kartalar PDF ko'rinishida",
      proFeatureMobile: '✨ Telefon va planshetlarda PLANKA',
      proFeatureSso: '✨ Kompaniya katalogingiz orqali kirish (SSO)',
      proFeatureThemes: '✨ Beshta mavzu va shaxsiy akssent rangingiz',
      proFeatureTimeline: "✨ Vaqt chizig'i: butun yil bitta o'qda",
      proTrialSelfHosted: "✨ PLANKA Pro ni o'z serveringizda 30 kun sinab ko'ring",
      project: 'Loyiha',
    ...
    action: {
      ...
      disableEditMode: "Tahrirlash rejimini o'chirish",
      ...
      filterByCurrentUser: "Joriy foydalanuvchi bo'yicha filtrlash",
      goBack: 'Orqaga qaytish',
      hideHiddenProjects: 'Yashirilgan loyihalarni yashirish',
      hideProjectList: "Loyihalar ro'yxatini yashirish",
      ...
      regenerateRecoveryCodes: 'Tiklash kodlarini qayta yaratish',
      remove: "O'chirish",
      ...
      showProjectList: "Loyihalar ro'yxatini ko'rsatish",
      sortList_title: "Ro'yxatni saralash",
      start: 'Boshlash',
      stayLoggedIn: 'Tizimda qolish',
      stop: "To'xtatish",
      subscribe: "Obuna bo'lish",
      switchToGridProjectsView: "Loyihalarni panjara ko'rinishida ko'rsatish",
      switchToGridView: "Panjara ko'rinishiga o'tish",
      switchToGroupedProjectsView: "Loyihalarni guruhlangan holda ko'rsatish",
      switchToKanbanView: "Kanban ko'rinishiga o'tish",
