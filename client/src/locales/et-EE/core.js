...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Lisa teavitusteenus',
      ...
      autoLogout: 'Automaatne väljalogimine',
      autoLogout_10m: '10 minuti pärast',
      autoLogout_12h: '12 tunni pärast',
      autoLogout_2m: '2 minuti pärast',
      autoLogout_30m: '30 minuti pärast',
      autoLogout_5m: '5 minuti pärast',
      autoLogout_never: 'Mitte kunagi',
      autoLogoutWarning_body: 'Tegevusetuse tõttu logitakse sind {{seconds}} s pärast välja.',
      autoLogoutWarning_title: 'Sind logitakse peagi välja',
      background: 'Taust',
      ...
      confirmCodesSaved: 'Olen need koodid turvalisse kohta salvestanud.',
      ...
      proFeatureDashboard: '✨ Üks töölaud kõigi projektide jaoks',
      proFeatureExport: '✨ Kaardid PDF-ina oma aruannete jaoks',
      proFeatureMobile: '✨ PLANKA telefonis ja tahvelarvutis',
      proFeatureSso: '✨ Logi sisse ettevõtte kataloogiga (SSO)',
      proFeatureThemes: '✨ Viis teemat ja oma rõhuvärv',
      proFeatureTimeline: '✨ Ajajoon: terve aasta ühel teljel',
      proTrialSelfHosted: '✨ Proovi PLANKA Pro-d 30 päeva oma serveris',
      dismissProBannerFor30Days: 'Sulge 30 päevaks',
      customerPanel_title: 'Kliendi paneel',
      dangerZone_title: 'Ohtliku ala',
      disable2fa_title: 'Keela kaheastmeline autentimine',
      disable2faWarning:
        'Pead kinnitama oma praeguse parooli ja TOTP-koodi. Olemasolevad seansid jäävad aktiivseks.',
      enable2fa_title: 'Luba kaheastmeline autentimine',
      enabledOn: 'Lubatud {{date}}',
      enterCodeFromApp: 'Sisesta 6-kohaline kood oma autentimisrakendusest.',
      enterPasswordToContinue: 'Jätkamiseks kinnita oma praegune parool.',
      enterTotpOrRecoveryCode:
        'Sisesta 6-kohaline kood oma autentimisrakendusest või üks oma taastekoodidest (xxxxx-xxxxx).',
      expires: 'Aegub',
      invalidTotpCode: 'Vale TOTP- või taastekood',
      lastUsed: 'Viimati kasutatud',
      never: 'Mitte kunagi',
      noTrustedDevices: 'Usaldusväärseid seadmeid pole.',
      orEnterSecretManually: 'Või sisesta see salajane võti käsitsi:',
      recoveryCodesExhausted:
        'Kõik taastekoodid on ära kasutatud. Genereeri uus komplekt, et sul oleks varuvariant juhuks, kui kaotad ligipääsu oma autentimisrakendusele.',
      recoveryCodesIntro:
        'Hoia neid koode turvalises kohas — igaüht saab kasutada ühe korra, kui kaotad ligipääsu oma autentimisrakendusele.',
      recoveryCodesLow_one: 'Alles on ainult {{count}} taastekood. Genereeri peagi uued.',
      recoveryCodesLow_other: 'Alles on ainult {{count}} taastekoodi. Genereeri peagi uued.',
      regenerateRecoveryCodes_title: 'Genereeri taastekoodid uuesti',
      regenerateRecoveryCodesIntro:
        'Uute koodide genereerimine muudab kõik olemasolevad taastekoodid kehtetuks.',
      reset2fa_title: 'Lähtesta 2FA',
      reset2faWarning:
        '2FA lähtestamine logib kasutaja välja kõigist seanssidest ja eemaldab tema TOTP-seadistuse. Järgmisel sisselogimisel peab ta selle uuesti seadistama.',
      saveTheseCodes_title: 'Salvesta need taastekoodid',
      scanQrCodeWithApp:
        'Skanni see QR-kood autentimisrakendusega, näiteks Google Authenticator või Authy.',
      security_title: 'Turvalisus',
      totpCode: 'TOTP-kood',
      totpOrRecoveryCode: 'TOTP- või taastekood',
      trustedDevices_title: 'Usaldusväärsed brauserid',
      trustedDevicesHint:
        'Usaldusväärseks märgitud brauserid ei küsi 30 päeva jooksul teist kinnitust. Eemalda need, mida sa enam ära ei tunne.',
      twoFactor_enabled: 'Kaheastmeline autentimine on lubatud.',
      twoFactor_intro:
        'Lisa oma kontole täiendav turvakiht, kasutades autentimisrakenduse ajapõhist ühekordset koodi.',
      twoFactorAuthentication: 'Kaheastmeline autentimine',
      ...
      openBoardActions: 'Ava tahvli tegevused',
      openBoard_title: 'Ava tahvel',
      openCardActions: 'Ava kaardi tegevused',
      openListActions: 'Ava nimekirja tegevused',
      openNotifications: 'Ava teavitused',
      openProjectActions: 'Ava projekti tegevused',
      openProjectSettings: 'Ava projekti seaded',
      ...
      showHiddenProjects: 'Näita peidetud projekte',
    ...
    action: {
      ...
      disableEditMode: 'Keela redigeerimisrežiim',
      ...
      emptyTrash_title: 'Tühjenda prügikast',
      enable2fa: 'Luba 2FA',
      enableEditMode: 'Luba redigeerimisrežiim',
      filterByCurrentUser: 'Filtreeri praeguse kasutaja järgi',
      goBack: 'Mine tagasi',
      hideHiddenProjects: 'Peida peidetud projektid',
      hideProjectList: 'Peida projektiloend',
      import: 'Impordi',
      join: 'Liitu',
      leave: 'Lahku',
      ...
      regenerateRecoveryCodes: 'Genereeri taastekoodid uuesti',
      remove: 'Eemalda',
      ...
      showProjectList: 'Näita projektiloendit',
      sortList_title: 'Sorteeri nimekiri',
      start: 'Alusta',
      stayLoggedIn: 'Jää sisse logituks',
      stop: 'Peata',
      subscribe: 'Telli',
      switchToGridProjectsView: 'Näita projekte ruudustikuna',
      switchToGridView: 'Lülitu ruudustikuvaatele',
      switchToGroupedProjectsView: 'Näita projekte rühmitatult',
      switchToKanbanView: 'Lülitu Kanban-vaatele',
      switchToListView: 'Lülitu nimekirjavaatele',
