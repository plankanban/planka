...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Додати службу сповіщень',
      ...
      autoLogout_10m: 'Через 10 хвилин',
      autoLogout_12h: 'Через 12 годин',
      autoLogout_2m: 'Через 2 хвилини',
      autoLogout_30m: 'Через 30 хвилин',
      autoLogout_5m: 'Через 5 хвилин',
      autoLogout_never: 'Ніколи',
      autoLogoutWarning_body:
        "Вас буде виведено із системи через {{seconds}}с у зв'язку з неактивністю.",
      autoLogoutWarning_title: 'Незабаром вас буде виведено із системи',
      background: 'Фон',
      ...
      color: 'Колір',
      comments: 'Коментарі',
      confirmCodesSaved: 'Я зберіг(ла) ці коди в безпечному місці.',
      ...
      proFeatureDashboard: '✨ Одна панель для всіх проектів',
      proFeatureExport: '✨ Картки у форматі PDF для ваших звітів',
      proFeatureMobile: '✨ PLANKA на телефонах і планшетах',
      proFeatureSso: '✨ Вхід через каталог вашої компанії (SSO)',
      proFeatureThemes: "✨ П'ять тем і власний акцентний колір",
      proFeatureTimeline: '✨ Таймлайн: цілий рік на одній осі',
      proTrialSelfHosted: '✨ Спробуйте PLANKA Pro 30 днів на власному сервері',
      dismissProBannerFor30Days: 'Закрити на 30 днів',
      customerPanel_title: 'Панель клієнта',
      dangerZone_title: 'Небезпечна зона',
      disable2fa_title: 'Вимкнути двофакторну аутентифікацію',
      disable2faWarning:
        'Вам потрібно буде підтвердити поточний пароль і TOTP-код. Наявні сеанси залишаться активними.',
      enable2fa_title: 'Увімкнути двофакторну аутентифікацію',
      enabledOn: 'Увімкнено {{date}}',
      enterCodeFromApp: 'Введіть 6-значний код із вашого додатка для аутентифікації.',
      enterPasswordToContinue: 'Підтвердіть поточний пароль, щоб продовжити.',
      enterTotpOrRecoveryCode:
        'Введіть 6-значний код із вашого додатка для аутентифікації або один із ваших кодів відновлення (xxxxx-xxxxx).',
      expires: 'Термін дії',
      invalidTotpCode: 'Неправильний TOTP-код або код відновлення',
      lastUsed: 'Останнє використання',
      never: 'Ніколи',
      noTrustedDevices: 'Немає довірених пристроїв.',
      openBoardActions: 'Відкрити дії з дошкою',
      openCardActions: 'Відкрити дії з карткою',
      openListActions: 'Відкрити дії зі списком',
      openNotifications: 'Відкрити сповіщення',
      openProjectActions: 'Відкрити дії з проектом',
      openProjectSettings: 'Відкрити налаштування проекту',
      orEnterSecretManually: 'Або введіть цей секретний ключ вручну:',
      recoveryCodesExhausted:
        'Усі коди відновлення використано. Перегенеруйте новий набір, щоб мати запасний варіант на випадок втрати доступу до додатка для аутентифікації.',
      recoveryCodesIntro:
        'Зберігайте ці коди в безпечному місці — кожен можна використати один раз, якщо ви втратите доступ до свого додатка для аутентифікації.',
      recoveryCodesLow_one:
        'Залишився лише {{count}} код відновлення. Радимо незабаром перегенерувати коди.',
      recoveryCodesLow_few:
        'Залишилося лише {{count}} коди відновлення. Радимо незабаром перегенерувати коди.',
      recoveryCodesLow_many:
        'Залишилося лише {{count}} кодів відновлення. Радимо незабаром перегенерувати коди.',
      recoveryCodesLow_other:
        'Залишилося лише {{count}} коду відновлення. Радимо незабаром перегенерувати коди.',
      regenerateRecoveryCodes_title: 'Перегенерувати коди відновлення',
      regenerateRecoveryCodesIntro:
        'Генерація нових кодів зробить усі наявні коди відновлення недійсними.',
      reset2fa_title: 'Скинути 2FA',
      reset2faWarning:
        'Скидання 2FA завершує всі сеанси користувача та видаляє його налаштування TOTP. Йому потрібно буде налаштувати 2FA знову під час наступного входу.',
      saveTheseCodes_title: 'Збережіть ці коди відновлення',
      scanQrCodeWithApp:
        'Відскануйте цей QR-код за допомогою додатка для аутентифікації, наприклад Google Authenticator або Authy.',
      security_title: 'Безпека',
      showHiddenProjects: 'Показати приховані проекти',
      totpCode: 'TOTP-код',
      totpOrRecoveryCode: 'TOTP-код або код відновлення',
      trustedDevices_title: 'Довірені браузери',
      trustedDevicesHint:
        'Браузери, позначені як довірені, пропускають другий фактор протягом 30 днів. Відкличте всі, які ви більше не впізнаєте.',
      twoFactor_enabled: 'Двофакторну аутентифікацію увімкнено.',
      twoFactor_intro:
        'Додайте додатковий рівень безпеки до свого облікового запису за допомогою тимчасового одноразового коду з додатка для аутентифікації.',
    ...
    action: {
      ...
      disableEditMode: 'Вимкнути режим редагування',
      ...
      enableEditMode: 'Увімкнути режим редагування',
      filterByCurrentUser: 'Фільтрувати за поточним користувачем',
      goBack: 'Назад',
      hideHiddenProjects: 'Сховати приховані проекти',
      hideProjectList: 'Приховати список проектів',
      import: 'Імпортувати',
      join: 'Приєднатися',
      leave: 'Покинути',
      ...
      regenerateRecoveryCodes: 'Перегенерувати коди відновлення',
      remove: 'Видалити',
      ...
      returnToProjects: 'Повернутися до проектів',
      revoke: 'Відкликати',
      save: 'Зберегти',
      ...
      showProjectList: 'Показати список проектів',
      sortList_title: 'Сортувати список',
      start: 'Почати',
      stayLoggedIn: 'Залишитися в системі',
      stop: 'Зупинити',
      subscribe: 'Підписатися',
      switchToGridProjectsView: 'Показати проекти сіткою',
      switchToGridView: 'Перемкнути на вигляд сітки',
      switchToGroupedProjectsView: 'Показати проекти згруповано',
      switchToKanbanView: 'Перемкнути на вигляд канбану',
      switchToListView: 'Перемкнути на вигляд списку',
