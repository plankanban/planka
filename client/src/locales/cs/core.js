...
export default {
  ...
  translation: {
    common: {
      ...
      color: 'Barva',
      connectionRestored_title: 'Spojení obnoveno',
      ...
      editBackground_title: 'Upravit pozadí',
      ...
      project: 'Projekt',
      projectActions_title: 'Akce na projektu',
      projectNotFound_title: 'Projekt nenalezen',
      refreshPageToLoadLastDataAndReceiveUpdates:
        '<0>Obnovit stránku</0> pro načtení posledních dat<br />a načtení aktualizací',
    ...
    action: {
      ...
      deleteBackground: 'Smazat pozadí',
