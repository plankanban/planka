...
export default {
  ...
  translation: {
    common: {
      ...
      autoLogoutWarning_body: 'Из-за бездействия вы выйдете из системы через {{seconds}} с.',
      autoLogoutWarning_title: 'Вы скоро выйдете из системы',
      autoLogout_10m: 'Через 10 минут',
      autoLogout_12h: 'Через 12 часов',
      autoLogout_2m: 'Через 2 минуты',
      autoLogout_30m: 'Через 30 минут',
      autoLogout_5m: 'Через 5 минут',
      autoLogout_never: 'Никогда',
      background: 'Фон',
      ...
      confirmCodesSaved: 'Я сохранил(а) эти коды в надёжном месте.',
      ...
      proFeatureDashboard: '✨ Единая панель для всех проектов',
      proFeatureExport: '✨ Карточки в PDF для ваших отчётов',
      proFeatureMobile: '✨ PLANKA на телефонах и планшетах',
      proFeatureSso: '✨ Вход через корпоративный каталог (SSO)',
      proFeatureThemes: '✨ Пять тем и собственный акцентный цвет',
      proFeatureTimeline: '✨ Таймлайн: целый год на одной оси',
      proTrialSelfHosted: '✨ Попробуйте PLANKA Pro 30 дней на своём сервере',
      ...
      disable2faWarning:
        'Вам потребуется подтвердить текущий пароль и TOTP-код. Существующие сеансы останутся активными.',
      disable2fa_title: 'Отключить двухфакторную аутентификацию',
      display: 'Отображение',
      ...
      enable2fa_title: 'Включить двухфакторную аутентификацию',
      enabledOn: 'Включено {{date}}',
      enterCardTitle: 'Введите заголовок для этой карточки...',
      enterCodeFromApp: 'Введите 6-значный код из приложения-аутентификатора.',
      enterDescription: 'Введите описание...',
      enterFilename: 'Введите название файла',
      enterListTitle: 'Введите заголовок списка...',
      enterPasswordToContinue: 'Подтвердите текущий пароль, чтобы продолжить.',
      enterTaskDescription: 'Введите описание задачи...',
      enterTotpOrRecoveryCode:
        'Введите 6-значный код из приложения-аутентификатора или один из ваших кодов восстановления (xxxxx-xxxxx).',
      events: 'События',
      ...
      invalidTotpCode: 'Неверный TOTP-код или код восстановления',
      kanban: 'Канбан',
      labels: 'Метки',
      language: 'Язык',
      ...
      noTrustedDevices: 'Доверенных устройств нет.',
      ...
      recoveryCodesExhausted:
        'Все коды восстановления использованы. Создайте новый набор, чтобы сохранить запасной вариант на случай потери доступа к приложению-аутентификатору.',
      recoveryCodesIntro:
        'Храните эти коды в надёжном месте — каждый из них можно использовать один раз, если вы потеряете доступ к приложению-аутентификатору.',
      recoveryCodesLow_few:
        'Осталось только {{count}} кода восстановления. Рекомендуем вскоре перегенерировать коды.',
      recoveryCodesLow_many:
        'Осталось только {{count}} кодов восстановления. Рекомендуем вскоре перегенерировать коды.',
      recoveryCodesLow_one:
        'Остался только {{count}} код восстановления. Рекомендуем вскоре перегенерировать коды.',
      ...
      regenerateRecoveryCodesIntro:
        'При создании новых кодов все существующие коды восстановления станут недействительными.',
      regenerateRecoveryCodes_title: 'Перегенерировать коды восстановления',
      ...
      reset2faWarning:
        'Сброс 2FA завершит все сеансы пользователя и удалит его настройку TOTP. При следующем входе ему потребуется настроить 2FA заново.',
      reset2fa_title: 'Сбросить 2FA',
      role: 'Роль',
      saveTheseCodes_title: 'Сохраните эти коды восстановления',
      saveThisKeyItWillNotBeShownAgain: 'Сохраните этот ключ — он больше не будет показан!',
      scanQrCodeWithApp:
        'Отсканируйте этот QR-код приложением-аутентификатором, например Google Authenticator или Authy.',
      ...
      title: 'Название',
      totpCode: 'TOTP-код',
      totpOrRecoveryCode: 'TOTP-код или код восстановления',
      trash: 'Корзина',
      trashHasBeenSuccessfullyEmptied: 'Корзина успешно очищена.',
      trustedDevicesHint:
        'Браузеры, отмеченные как доверенные, не запрашивают второй фактор в течение 30 дней. Отзовите те, которые вы больше не узнаёте.',
      trustedDevices_title: 'Доверенные браузеры',
      turnOffRecentCardHighlighting: 'Выключить подсветку последних карточек',
      twoFactorAuthentication: 'Двухфакторная аутентификация',
      twoFactor_enabled: 'Двухфакторная аутентификация включена.',
      twoFactor_intro:
        'Добавьте дополнительный уровень защиты для вашей учетной записи с помощью временного одноразового кода из приложения-аутентификатора.',
