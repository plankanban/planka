...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Dodaj uslugu obaveštenja',
      ...
      autoLogoutWarning_body: 'Bićete odjavljeni za {{seconds}}s zbog neaktivnosti.',
      autoLogoutWarning_title: 'Uskoro ćete biti odjavljeni',
      autoLogout_10m: 'Nakon 10 minuta',
      autoLogout_12h: 'Nakon 12 sati',
      autoLogout_2m: 'Nakon 2 minuta',
      autoLogout_30m: 'Nakon 30 minuta',
      autoLogout_5m: 'Nakon 5 minuta',
      autoLogout_never: 'Nikada',
      background: 'Pozadina',
      ...
      color: 'Boja',
      comments: 'Komentari',
      confirmCodesSaved: 'Sačuvao sam ove kodove na sigurnom mestu.',
      ...
      proFeatureDashboard: '✨ Jedna kontrolna tabla za sve projekte',
      proFeatureExport: '✨ Kartice u PDF-u za vaše izveštaje',
      proFeatureMobile: '✨ PLANKA na telefonima i tabletima',
      proFeatureSso: '✨ Prijava preko direktorijuma vaše kompanije (SSO)',
      proFeatureThemes: '✨ Pet tema i vaša akcentna boja',
      proFeatureTimeline: '✨ Vremenska linija: cela godina na jednoj osi',
      proTrialSelfHosted: '✨ Isprobajte PLANKA Pro 30 dana na sopstvenom serveru',
      ...
      description: 'Opis',
      disable2faWarning:
        'Moraćete da potvrdite svoju trenutnu lozinku i TOTP kod. Postojeće sesije ostaju prijavljene.',
      disable2fa_title: 'Onemogući dvofaktorsku autentifikaciju',
      display: 'Prikaz',
      ...
      enable2fa_title: 'Omogući dvofaktorsku autentifikaciju',
      enabledOn: 'Omogućeno {{date}}',
      enterCardTitle: 'Unesi naslov kartice...',
      enterCodeFromApp: 'Unesite šestocifreni kod iz vaše aplikacije za autentifikaciju.',
      enterDescription: 'Unesi opis...',
      enterFilename: 'Unesi naziv datoteke',
      enterListTitle: 'Unesi naslov spiska...',
      enterPasswordToContinue: 'Potvrdite svoju trenutnu lozinku da biste nastavili.',
      enterTaskDescription: 'Unesi opis zadatka...',
      enterTotpOrRecoveryCode:
        'Unesite šestocifreni kod iz vaše aplikacije za autentifikaciju ili jedan od vaših kodova za oporavak (xxxxx-xxxxx).',
      events: 'Događaji',
      ...
      invalidTotpCode: 'Neispravan TOTP ili kod za oporavak',
      kanban: 'Kanban',
      labels: 'Oznake',
      language: 'Jezik',
      ...
      noTrustedDevices: 'Nema pouzdanih uređaja.',
      ...
      openBoardActions: 'Otvori radnje nad tablom',
      openBoard_title: 'Otvori tablu',
      openCardActions: 'Otvori radnje nad karticom',
      openListActions: 'Otvori radnje nad spiskom',
      openNotifications: 'Otvori obaveštenja',
      openProjectActions: 'Otvori radnje nad projektom',
      openProjectSettings: 'Otvori podešavanja projekta',
      optional_inline: 'opciono',
      orEnterSecretManually: 'Ili ručno unesite ovaj tajni ključ:',
      ...
      recoveryCodesExhausted:
        'Svi kodovi za oporavak su iskorišćeni. Generišite novi set da biste zadržali rezervni pristup u slučaju da izgubite aplikaciju za autentifikaciju.',
      recoveryCodesIntro:
        'Čuvajte ove kodove na sigurnom mestu — svaki se može upotrebiti jednom ako izgubite pristup aplikaciji za autentifikaciju.',
      recoveryCodesLow_one:
        'Preostao je još samo {{count}} kod za oporavak. Razmislite o skorom regenerisanju.',
      recoveryCodesLow_few:
        'Preostala su još samo {{count}} koda za oporavak. Razmislite o skorom regenerisanju.',
      recoveryCodesLow_other:
        'Preostalo je još samo {{count}} kodova za oporavak. Razmislite o skorom regenerisanju.',
      ...
      regenerateRecoveryCodesIntro:
        'Generisanjem novih kodova svi postojeći kodovi za oporavak postaju nevažeći.',
      regenerateRecoveryCodes_title: 'Regeneriši kodove za oporavak',
      ...
      reset2faWarning:
        'Resetovanje 2FA odjavljuje korisnika iz svih sesija i uklanja njegovo TOTP podešavanje. Moraće ponovo da ga podesi pri sledećoj prijavi.',
      reset2fa_title: 'Resetuj 2FA',
      role: 'Uloga',
      saveTheseCodes_title: 'Sačuvaj ove kodove za oporavak',
      saveThisKeyItWillNotBeShownAgain: 'Sačuvajte ovaj ključ — neće biti prikazan ponovo!',
      scanQrCodeWithApp:
        'Skenirajte ovaj QR kod aplikacijom za autentifikaciju kao što je Google Authenticator ili Authy.',
      ...
      showHiddenProjects: 'Prikaži skrivene projekte',
      ...
      title: 'Naslov',
      totpCode: 'TOTP kod',
      totpOrRecoveryCode: 'TOTP ili kod za oporavak',
      trash: 'Korpa',
      trashHasBeenSuccessfullyEmptied: 'Korpa je uspešno ispražnjena.',
      trustedDevicesHint:
        'Pregledači označeni kao pouzdani preskaču drugi faktor 30 dana. Opozovite sve koje više ne prepoznajete.',
      trustedDevices_title: 'Pouzdani pregledači',
      turnOffRecentCardHighlighting: 'Isključi isticanje skorašnjih kartica',
      twoFactorAuthentication: 'Dvofaktorska autentifikacija',
      twoFactor_enabled: 'Dvofaktorska autentifikacija je omogućena.',
      twoFactor_intro:
        'Dodajte dodatni sloj bezbednosti svom nalogu koristeći vremenski zasnovan jednokratni kod iz aplikacije za autentifikaciju.',
    ...
    action: {
      ...
      disableEditMode: 'Isključi režim uređivanja',
      ...
      filterByCurrentUser: 'Filtriraj prema trenutnom korisniku',
      goBack: 'Nazad',
      hideHiddenProjects: 'Sakrij skrivene projekte',
      hideProjectList: 'Sakrij listu projekata',
      import: 'Uvezi',
      join: 'Pridruži se',
      leave: 'Napusti',
      leaveBoard: 'Napusti tablu',
      leaveProject: 'Napusti projekat',
      logOutNow: 'Odjavi se odmah',
      logOut_title: 'Odjava',
      ...
      reset2fa: 'Resetuj 2FA',
      restoreToList: 'Vrati u {{list}}',
      returnToBoard: 'Vrati se na tablu',
      returnToProjects: 'Vrati se na projekte',
      revoke: 'Opozovi',
      save: 'Sačuvaj',
      ...
      showProjectList: 'Prikaži listu projekata',
      sortList_title: 'Složi spisak',
      start: 'Počni',
      stayLoggedIn: 'Ostani prijavljen',
      stop: 'Zaustavi',
      subscribe: 'Pretplati se',
      switchToGridProjectsView: 'Prikaži projekte u mreži',
      switchToGridView: 'Pređi na prikaz mreže',
      switchToGroupedProjectsView: 'Prikaži projekte grupisano',
      switchToKanbanView: 'Pređi na kanban prikaz',
      switchToListView: 'Pređi na prikaz spiska',
