...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Ajouter un service de notification',
      ...
      openBoardActions: 'Ouvrir les actions du tableau',
      openCardActions: 'Ouvrir les actions de la carte',
      openListActions: 'Ouvrir les actions de la liste',
      openNotifications: 'Ouvrir les notifications',
      openProjectActions: 'Ouvrir les actions du projet',
      openProjectSettings: 'Ouvrir les réglages du projet',
    ...
    action: {
      ...
      filterByCurrentUser: 'Filtrer par utilisateur actuel',
      goBack: 'Retour',
      hideHiddenProjects: 'Ne plus afficher les projets masqués',
      hideProjectList: 'Masquer la liste des projets',
      import: 'Importer',
      join: 'Rejoindre',
      leave: 'Quitter',
      ...
      returnToProjects: 'Retourner aux projets',
      revoke: 'Révoquer',
      save: 'Sauvegarder',
      ...
      showLess: 'Voir moins',
      showMore: 'Voir plus',
      showProjectList: 'Afficher la liste des projets',
      sortList_title: 'Trier la liste',
      start: 'Commencer',
      stayLoggedIn: 'Rester connecté',
      stop: 'Arrêter',
      subscribe: "S'abonner",
      switchToGridProjectsView: 'Afficher les projets en grille',
      switchToGridView: 'Passer à la vue grille',
      switchToGroupedProjectsView: 'Afficher les projets groupés',
      switchToKanbanView: 'Passer à la vue Kanban',
