...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Lisää ilmoituspalvelu',
      ...
      autoLogout_10m: '10 minuutin kuluttua',
      autoLogout_12h: '12 tunnin kuluttua',
      autoLogout_2m: '2 minuutin kuluttua',
      autoLogout_30m: '30 minuutin kuluttua',
      autoLogout_5m: '5 minuutin kuluttua',
      autoLogout_never: 'Ei koskaan',
      autoLogoutWarning_body:
        'Sinut kirjataan ulos {{seconds}} sekunnin kuluttua toimettomuuden vuoksi.',
      autoLogoutWarning_title: 'Sinut kirjataan pian ulos',
      background: 'Tausta',
      ...
      color: 'Väri',
      comments: 'Kommentit',
      confirmCodesSaved: 'Olen tallentanut nämä koodit turvalliseen paikkaan.',
      ...
      proFeatureDashboard: '✨ Yksi koontinäyttö kaikille projekteille',
      proFeatureExport: '✨ Kortit PDF-muodossa raportointiin',
      proFeatureMobile: '✨ PLANKA puhelimissa ja tableteissa',
      proFeatureSso: '✨ Kirjautuminen yrityksesi hakemistolla (SSO)',
      proFeatureThemes: '✨ Viisi teemaa ja oma korostusväri',
      proFeatureTimeline: '✨ Aikajana: koko vuosi yhdellä akselilla',
      proTrialSelfHosted: '✨ Kokeile PLANKA Pro:ta 30 päivää omalla palvelimellasi',
      dismissProBannerFor30Days: 'Sulje 30 päiväksi',
      customerPanel_title: 'Asiakaspaneeli',
      dangerZone_title: 'Vaaravyöhyke',
      disable2fa_title: 'Poista kaksivaiheinen tunnistautuminen käytöstä',
      disable2faWarning:
        'Sinun täytyy vahvistaa nykyinen salasanasi ja TOTP-koodi. Nykyiset istunnot pysyvät kirjautuneina.',
      enable2fa_title: 'Ota kaksivaiheinen tunnistautuminen käyttöön',
      enabledOn: 'Otettu käyttöön {{date}}',
      enterCodeFromApp: 'Syötä 6-numeroinen koodi todennussovelluksestasi.',
      enterPasswordToContinue: 'Vahvista nykyinen salasanasi jatkaaksesi.',
      enterTotpOrRecoveryCode:
        'Syötä 6-numeroinen koodi todennussovelluksestasi tai jokin palautuskoodeistasi (xxxxx-xxxxx).',
      expires: 'Vanhenee',
      invalidTotpCode: 'Virheellinen TOTP- tai palautuskoodi',
      lastUsed: 'Viimeksi käytetty',
      never: 'Ei koskaan',
      noTrustedDevices: 'Ei luotettuja laitteita.',
      orEnterSecretManually: 'Tai syötä tämä salainen avain manuaalisesti:',
      recoveryCodesExhausted:
        'Kaikki palautuskoodit on käytetty. Luo uusi sarja, jotta sinulla on varakeino, jos menetät pääsyn todennussovellukseesi.',
      recoveryCodesIntro:
        'Säilytä nämä koodit turvallisessa paikassa — kutakin voi käyttää kerran, jos menetät pääsyn todennussovellukseesi.',
      recoveryCodesLow_one: 'Vain {{count}} palautuskoodi jäljellä. Harkitse uusien luomista pian.',
      recoveryCodesLow_other:
        'Vain {{count}} palautuskoodia jäljellä. Harkitse uusien luomista pian.',
      regenerateRecoveryCodes_title: 'Luo palautuskoodit uudelleen',
      regenerateRecoveryCodesIntro:
        'Uusien koodien luominen mitätöi kaikki nykyiset palautuskoodit.',
      reset2fa_title: 'Nollaa 2FA',
      reset2faWarning:
        'Kaksivaiheisen tunnistautumisen nollaaminen kirjaa käyttäjän ulos kaikista istunnoista ja poistaa hänen TOTP-määrityksensä. Hänen täytyy määrittää se uudelleen seuraavalla kirjautumiskerralla.',
      saveTheseCodes_title: 'Tallenna nämä palautuskoodit',
      scanQrCodeWithApp:
        'Skannaa tämä QR-koodi todennussovelluksella, kuten Google Authenticator tai Authy.',
      security_title: 'Tietoturva',
      totpCode: 'TOTP-koodi',
      totpOrRecoveryCode: 'TOTP- tai palautuskoodi',
      trustedDevices_title: 'Luotetut selaimet',
      trustedDevicesHint:
        'Luotetuiksi merkityt selaimet ohittavat toisen vaiheen 30 päivän ajan. Mitätöi ne, joita et enää tunnista.',
      twoFactor_enabled: 'Kaksivaiheinen tunnistautuminen on käytössä.',
      twoFactor_intro:
        'Lisää tilillesi ylimääräinen suojaustaso käyttämällä todennussovelluksen aikaan perustuvaa kertakäyttökoodia.',
      ...
      openBoardActions: 'Avaa taulun toiminnot',
      openBoard_title: 'Avaa taulu',
      openCardActions: 'Avaa kortin toiminnot',
      openListActions: 'Avaa listan toiminnot',
      openNotifications: 'Avaa ilmoitukset',
      openProjectActions: 'Avaa projektin toiminnot',
      openProjectSettings: 'Avaa projektin asetukset',
      ...
      showHiddenProjects: 'Näytä piilotetut projektit',
    ...
    action: {
      ...
      disable2fa: 'Poista 2FA käytöstä',
      disableEditMode: 'Poistu muokkaustilasta',
      ...
      emptyTrash_title: 'Tyhjennä roskakori',
      enable2fa: 'Ota 2FA käyttöön',
      enableEditMode: 'Siirry muokkaustilaan',
      filterByCurrentUser: 'Suodata nykyisen käyttäjän mukaan',
      goBack: 'Palaa takaisin',
      hideHiddenProjects: 'Piilota piilotetut projektit',
      hideProjectList: 'Piilota projektilista',
      import: 'Tuo',
      join: 'Liity',
      leave: 'Poistu',
      ...
      regenerateRecoveryCodes: 'Luo palautuskoodit uudelleen',
      remove: 'Poista',
      ...
      returnToProjects: 'Palaa projekteihin',
      revoke: 'Mitätöi',
      save: 'Tallenna',
      ...
      showProjectList: 'Näytä projektilista',
      sortList_title: 'Lajittele lista',
      start: 'Aloita',
      stayLoggedIn: 'Pysy kirjautuneena',
      stop: 'Lopeta',
      subscribe: 'Tilaa',
      switchToGridProjectsView: 'Näytä projektit ruudukkona',
      switchToGridView: 'Vaihda ruudukkonäkymään',
      switchToGroupedProjectsView: 'Näytä projektit ryhmiteltyinä',
      switchToKanbanView: 'Vaihda kanban-näkymään',
      switchToListView: 'Vaihda listanäkymään',
