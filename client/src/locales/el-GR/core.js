...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Προσθήκη υπηρεσίας ειδοποιήσεων',
      ...
      autoLogout_10m: 'Μετά από 10 λεπτά',
      autoLogout_12h: 'Μετά από 12 ώρες',
      autoLogout_2m: 'Μετά από 2 λεπτά',
      autoLogout_30m: 'Μετά από 30 λεπτά',
      autoLogout_5m: 'Μετά από 5 λεπτά',
      autoLogout_never: 'Ποτέ',
      autoLogoutWarning_body: 'Θα αποσυνδεθείτε σε {{seconds}} δευτ. λόγω αδράνειας.',
      autoLogoutWarning_title: 'Θα αποσυνδεθείτε σύντομα',
      background: 'Φόντο',
      ...
      color: 'Χρώμα',
      comments: 'Σχόλια',
      confirmCodesSaved: 'Έχω αποθηκεύσει αυτούς τους κωδικούς σε ασφαλές μέρος.',
      ...
      proFeatureDashboard: '✨ Ένας πίνακας ελέγχου για όλα τα έργα',
      proFeatureExport: '✨ Κάρτες σε PDF για τις αναφορές σας',
      proFeatureMobile: '✨ Το PLANKA σε κινητά και tablet',
      proFeatureSso: '✨ Σύνδεση με τον κατάλογο της εταιρείας σας (SSO)',
      proFeatureThemes: '✨ Πέντε θέματα και το δικό σας χρώμα τονισμού',
      proFeatureTimeline: '✨ Timeline: όλη η χρονιά σε έναν άξονα',
      proTrialSelfHosted: '✨ Δοκιμάστε το PLANKA Pro για 30 ημέρες στον δικό σας διακομιστή',
      dismissProBannerFor30Days: 'Κλείσιμο για 30 ημέρες',
      customerPanel_title: 'Πίνακας πελάτη',
      dangerZone_title: 'Επικίνδυνη ζώνη',
      disable2fa_title: 'Απενεργοποίηση ταυτοποίησης δύο παραγόντων',
      disable2faWarning:
        'Θα χρειαστεί να επιβεβαιώσετε τον τρέχοντα κωδικό σας και έναν κωδικό TOTP. Οι υπάρχουσες συνεδρίες παραμένουν συνδεδεμένες.',
      enable2fa_title: 'Ενεργοποίηση ταυτοποίησης δύο παραγόντων',
      enabledOn: 'Ενεργοποιήθηκε στις {{date}}',
      enterCodeFromApp: 'Εισάγετε τον 6ψήφιο κωδικό από την εφαρμογή ταυτοποίησης.',
      enterPasswordToContinue: 'Επιβεβαιώστε τον τρέχοντα κωδικό σας για να συνεχίσετε.',
      enterTotpOrRecoveryCode:
        'Εισάγετε τον 6ψήφιο κωδικό από την εφαρμογή ταυτοποίησης ή έναν από τους κωδικούς ανάκτησης (xxxxx-xxxxx).',
      expires: 'Λήγει',
      invalidTotpCode: 'Μη έγκυρος κωδικός TOTP ή ανάκτησης',
      lastUsed: 'Τελευταία χρήση',
      never: 'Ποτέ',
      noTrustedDevices: 'Δεν υπάρχουν έμπιστες συσκευές.',
      orEnterSecretManually: 'Ή εισάγετε αυτό το μυστικό κλειδί χειροκίνητα:',
      recoveryCodesExhausted:
        'Όλοι οι κωδικοί ανάκτησης έχουν χρησιμοποιηθεί. Δημιουργήστε νέους για να έχετε εναλλακτική λύση σε περίπτωση που χάσετε την εφαρμογή ταυτοποίησης.',
      recoveryCodesIntro:
        'Φυλάξτε αυτούς τους κωδικούς σε ασφαλές μέρος — καθένας μπορεί να χρησιμοποιηθεί μία φορά αν χάσετε την πρόσβαση στην εφαρμογή ταυτοποίησης.',
      recoveryCodesLow_one:
        'Απομένει μόνο {{count}} κωδικός ανάκτησης. Δημιουργήστε νέους σύντομα.',
      recoveryCodesLow_other:
        'Απομένουν μόνο {{count}} κωδικοί ανάκτησης. Δημιουργήστε νέους σύντομα.',
      regenerateRecoveryCodes_title: 'Αναδημιουργία κωδικών ανάκτησης',
      regenerateRecoveryCodesIntro:
        'Η δημιουργία νέων κωδικών θα ακυρώσει όλους τους υπάρχοντες κωδικούς ανάκτησης.',
      reset2fa_title: 'Επαναφορά 2FA',
      reset2faWarning:
        'Η επαναφορά της 2FA αποσυνδέει τον χρήστη από όλες τις συνεδρίες και καταργεί τη ρύθμιση TOTP. Θα χρειαστεί να την ρυθμίσει ξανά κατά την επόμενη σύνδεση.',
      saveTheseCodes_title: 'Αποθήκευση αυτών των κωδικών ανάκτησης',
      scanQrCodeWithApp:
        'Σαρώστε αυτόν τον κωδικό QR με μια εφαρμογή ταυτοποίησης όπως το Google Authenticator ή το Authy.',
      security_title: 'Ασφάλεια',
      totpCode: 'Κωδικός TOTP',
      totpOrRecoveryCode: 'Κωδικός TOTP ή ανάκτησης',
      trustedDevices_title: 'Έμπιστα προγράμματα περιήγησης',
      trustedDevicesHint:
        'Τα προγράμματα περιήγησης που έχουν επισημανθεί ως έμπιστα παρακάμπτουν τον δεύτερο παράγοντα για 30 ημέρες. Ανακαλέστε όσα δεν αναγνωρίζετε πλέον.',
      twoFactor_enabled: 'Η ταυτοποίηση δύο παραγόντων είναι ενεργοποιημένη.',
      twoFactor_intro:
        'Προσθέστε ένα επιπλέον επίπεδο ασφάλειας στον λογαριασμό σας χρησιμοποιώντας έναν κωδικό μίας χρήσης βάσει χρόνου από μια εφαρμογή ταυτοποίησης.',
      ...
      openBoardActions: 'Άνοιγμα ενεργειών πίνακα',
      openBoard_title: 'Άνοιγμα πίνακα',
      openCardActions: 'Άνοιγμα ενεργειών κάρτας',
      openListActions: 'Άνοιγμα ενεργειών λίστας',
      openNotifications: 'Άνοιγμα ειδοποιήσεων',
      openProjectActions: 'Άνοιγμα ενεργειών έργου',
      ...
      showHiddenProjects: 'Εμφάνιση κρυφών έργων',
    ...
    action: {
      ...
      disableEditMode: 'Απενεργοποίηση λειτουργίας επεξεργασίας',
      ...
      enableEditMode: 'Ενεργοποίηση λειτουργίας επεξεργασίας',
      filterByCurrentUser: 'Φιλτράρισμα κατά τρέχοντα χρήστη',
      goBack: 'Πίσω',
      hideHiddenProjects: 'Απόκρυψη κρυφών έργων',
      hideProjectList: 'Απόκρυψη λίστας έργων',
      import: 'Εισαγωγή',
      join: 'Συμμετοχή',
      leave: 'Αποχώρηση',
      ...
      regenerateRecoveryCodes: 'Αναδημιουργία κωδικών ανάκτησης',
      remove: 'Αφαίρεση',
      ...
      showProjectList: 'Εμφάνιση λίστας έργων',
      sortList_title: 'Ταξινόμηση λίστας',
      start: 'Έναρξη',
      stayLoggedIn: 'Παραμονή σε σύνδεση',
      stop: 'Διακοπή',
      subscribe: 'Εγγραφή',
      switchToGridProjectsView: 'Εμφάνιση έργων σε πλέγμα',
      switchToGridView: 'Εναλλαγή σε προβολή πλέγματος',
      switchToGroupedProjectsView: 'Εμφάνιση έργων σε ομάδες',
      switchToKanbanView: 'Εναλλαγή σε προβολή Kanban',
      switchToListView: 'Εναλλαγή σε προβολή λίστας',
