export default {
  ...
  translation: {
      common: {
        allChangesWillBeAutomaticallySavedAfterConnectionRestored: "Az összes változás automatikusan mentésre kerül a kapcsolat helyreállása után.",
        ...
        areYouSureYouWantToRemoveThisManagerFromProject: "Biztosan eltávolítja ezt a vezetőt a projektből?",
        ...
        userAddedThisCardToList: "<0>{{user}}</0><1> hozzáadta ezt a kártyát a következőhöz: {{list}}</1>",
        userLeftNewCommentToCard: "{{user}} új kommentet hagyott itt: «{{comment}}» a következő kártyán: <2>{{card}}</2>",
        userMovedCardFromListToList: "{{user}} áthelyezte ezt a kártyát innen: {{fromList}} ide: {{toList}}",
        userMovedThisCardFromListToList: "<0>{{user}}</0><1> áthelyezte ezt a kártyát innen: {{fromList}} ide: {{toList}}</1>",
