...
export default {
  ...
  translation: {
    common: {
      ...
      color: 'Color',
      connectionRestored_title: 'Conexión restaurada',
      ...
      editBackground_title: 'Editar fondo',
      ...
      project: 'Proyecto',
      projectActions_title: 'Acciones del Proyecto',
      projectNotFound_title: 'Proyecto no encontrado',
      refreshPageToLoadLastDataAndReceiveUpdates:
        '<0>Refresca la página</0> para cargar los últimos datos<br />y recibir actualizaciones',
