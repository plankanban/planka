  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisAttachment:
       ...
       areYouSureYouWantToDeleteThisCard: 'Bu kartı silmek istediğinizden emin misiniz?',
        ...
        areYouSureYouWantToRemoveThisMemberFromBoard:
         'Bu üyeyi yönetim kurulundan çıkarmak istediğinizden emin misiniz?',
        attachment: 'ek',
        attachments: 'ekler',
        authentication: 'kimlik doğrulama',
        background: 'arka plan',
        board: 'tahta',
        boardNotFound_title: 'Kart bulunamadı',
        ...
        editAvatar_title: 'Avatar'ı Düzenle',
        ...
        general: 'Genel',
        hours: 'saat',
        invalidCurrentPassword: 'Geçerli şifre yanlış',
        labels: 'etiketler',
        language: 'dil',
        leaveBoard_title: 'Kuruldan Ayrıl',
        ...
        pressPasteShortcutToAddAttachmentFromClipboard'a basın:
         'İpucu: Panodan bir ek eklemek için CTRL-V'ye (Mac'te Cmd-V) basın',
        project: 'Proje',
        ...
        userAddedThisCardToList: '<0>{{user}}</0><1> bu kartı {{list}</1>'e ekledi',
        userLeftNewCommentToCard:
         '{{user}} yeni bir yorum yazdı: <2>{{card}</2>'da «{{comment}}»,
        userMovedCardFromListToList:
         '{{user}}, <2>{{card}></2>'yi {{fromList}}'tan {{toList}}'a taşıdı',
     ...
     action: {
        ...
        save: 'Kaydet',
        showAllAttachments: 'Tüm ekleri göster ({{gizli}} gizli)',
