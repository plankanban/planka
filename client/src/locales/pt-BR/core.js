...
export default {
  ...
  translation: {
    common: {
      ...
      autoLogoutWarning_body: 'Você será desconectado em {{seconds}}s por inatividade.',
      autoLogoutWarning_title: 'Você será desconectado em breve',
      background: 'Fundo',
      ...
      confirmCodesSaved: 'Salvei estes códigos em um local seguro.',
      ...
      proFeatureDashboard: '✨ Um painel para todos os projetos',
      proFeatureExport: '✨ Cartões em PDF para seus relatórios',
      proFeatureMobile: '✨ PLANKA no celular e no tablet',
      proFeatureSso: '✨ Entre com o diretório da sua empresa (SSO)',
      proFeatureThemes: '✨ Cinco temas e sua própria cor de destaque',
      proFeatureTimeline: '✨ Linha do tempo: um ano inteiro em um só eixo',
      proTrialSelfHosted: '✨ Experimente o PLANKA Pro por 30 dias no seu próprio servidor',
      ...
      disable2faWarning:
        'Você precisará confirmar sua senha atual e um código TOTP. As sessões existentes permanecerão conectadas.',
      enable2fa_title: 'Ativar autenticação de dois fatores',
      enabledOn: 'Ativado em {{date}}',
      enterCodeFromApp: 'Digite o código de 6 dígitos do seu aplicativo autenticador.',
      enterPasswordToContinue: 'Confirme sua senha atual para continuar.',
      enterTotpOrRecoveryCode:
        'Digite o código de 6 dígitos do seu aplicativo autenticador ou um dos seus códigos de recuperação (xxxxx-xxxxx).',
      expires: 'Expiração',
      invalidTotpCode: 'Código TOTP ou de recuperação inválido',
      lastUsed: 'Último uso',
      never: 'Nunca',
      noTrustedDevices: 'Nenhum dispositivo confiável.',
      ...
      orEnterSecretManually: 'Ou digite esta chave secreta manualmente:',
      recoveryCodesExhausted:
        'Todos os códigos de recuperação foram usados. Gere um novo conjunto para manter uma alternativa caso você perca o acesso ao seu aplicativo autenticador.',
      recoveryCodesIntro:
        'Guarde estes códigos em um local seguro — cada um pode ser usado uma vez caso você perca o acesso ao seu aplicativo autenticador.',
      ...
      reset2fa_title: 'Redefinir 2FA',
      reset2faWarning:
        'Redefinir a 2FA desconecta o usuário de todas as sessões e remove a configuração TOTP dele. Será necessário configurá-la novamente no próximo login.',
      saveTheseCodes_title: 'Salvar estes códigos de recuperação',
      scanQrCodeWithApp:
        'Escaneie este código QR com um aplicativo autenticador, como o Google Authenticator ou o Authy.',
      security_title: 'Segurança',
      showHiddenProjects: 'Mostrar projetos ocultos',
      totpCode: 'Código TOTP',
      totpOrRecoveryCode: 'Código TOTP ou de recuperação',
      trustedDevices_title: 'Navegadores confiáveis',
      trustedDevicesHint:
        'Navegadores marcados como confiáveis dispensam o segundo fator por 30 dias. Revogue os que você não reconhecer mais.',
      twoFactor_enabled: 'A autenticação de dois fatores está ativada.',
      twoFactor_intro:
        'Adicione uma camada extra de segurança à sua conta usando um código de uso único baseado em tempo, gerado por um aplicativo autenticador.',
    ...
    action: {
      ...
      filterByCurrentUser: 'Filtrar por usuário atual',
      goBack: 'Voltar',
      ...
      switchToGridProjectsView: 'Mostrar projetos em grade',
