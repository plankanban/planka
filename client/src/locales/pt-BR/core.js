...
export default {
	...
	translation: {
		common: {
			...
			areYouSureYouWantToAssignThisProjectManagerAsOwner: 'Tem certeza de que deseja atribuir este gerente de projeto como proprietário?',
			...
			areYouSureYouWantToDeleteThisBackgroundImage: 'Tem certeza que deseja excluir esta imagem de fundo?',
			...
			areYouSureYouWantToDeleteThisCardForever: 'Tem certeza de que deseja excluir este cartão para sempre?',
			...
			areYouSureYouWantToDeleteThisCustomFieldGroup: 'Tem certeza de que deseja excluir este grupo de campo personalizado?',
			...
			areYouSureYouWantToMakeThisProjectPrivate: 'Tem certeza de que deseja tornar este projeto privado?',
			areYouSureYouWantToMakeThisProjectShared: 'Tem certeza de que deseja tornar este projeto compartilhado?',
			...
			canCreateOwnProjectsAndBeInvitedToWorkInOthers: 'Pode criar seus próprios projetos e ser convidado para trabalhar em outros',
			canEditBoardLayoutAndAssignMembersToCards: 'Pode editar o layout do quadro e atribuir membros aos cartões',
			canManageSystemWideSettingsAndActAsProjectOwner: 'Pode gerenciar configurações de sistema e atuar como proprietário do projeto',
			canOnlyViewBoard: 'Só pode visualizar o quadro.',
			cardActions_title: 'Ações do Cartão',
			cardNotFound_title: 'Cartão não encontrado',
			cardsOnThisListAreAvailableToAllBoardMembers: 'Os cartões nesta lista estão disponíveis para todos os membros do quadro.',
			cardsOnThisListAreCompleteAndReadyToBeArchived: 'Os cartões nesta lista estão completos e prontos para serem arquivados.',
			...
			contentOfThisAttachmentIsTooBigToDisplay: 'O conteúdo deste anexo é muito grande para ser exibido.',
			copy_inline: 'copiar',
			...
			deleteAllBoardsToBeAbleToDeleteThisProject: 'Excluir todos os quadros para poder excluir este projeto',
			...
			onlyOneManagerShouldRemainToMakeThisProjectPrivate: 'Apenas um gerente deve permanecer para tornar este projeto privado',
			openBoard_title: 'Abrir Quadro',
			optional_inline: 'opcional',
			organization: 'Organização',
			others: 'Outros',
			phone: 'Telefone',
			plankaUsesAppriseToSendNotificationsToOver100PopularServices: 'PLANKA usa <1><0>Apprise</0></1> para enviar notificações para mais de 100 serviços populares.',
			...
			userMarkedTaskIncompleteOnCard: '<0>{{user}}</0> marcou {{task}} como incompleta em <4>{{card}}</4>',
			userMarkedTaskIncompleteOnThisCard: '<0>{{user}}</0> marcou {{task}} como incompleta neste cartão',
			userMentionedYouInCommentOnCard: '<0>{{user}}</0> mencionou você em um comentário «{{comment}}» em <2>{{card}}</2>',
