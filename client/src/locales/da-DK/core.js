...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Tilføj notifikationstjeneste',
      ...
      autoLogout: 'Automatisk udlogning',
      autoLogout_10m: 'Efter 10 minutter',
      autoLogout_12h: 'Efter 12 timer',
      autoLogout_2m: 'Efter 2 minutter',
      autoLogout_30m: 'Efter 30 minutter',
      autoLogout_5m: 'Efter 5 minutter',
      autoLogout_never: 'Aldrig',
      autoLogoutWarning_body: 'Du bliver logget ud om {{seconds}}s på grund af inaktivitet.',
      autoLogoutWarning_title: 'Du bliver snart logget ud',
      ...
      confirmCodesSaved: 'Jeg har gemt disse koder et sikkert sted.',
      ...
      disable2fa_title: 'Deaktivér to-faktor-autentificering',
      disable2faWarning:
        'Du skal bekræfte din nuværende adgangskode og en TOTP-kode. Eksisterende sessioner forbliver logget på.',
      display: 'Vis',
      ...
      enable2fa_title: 'Aktivér to-faktor-autentificering',
      enabledOn: 'Aktiveret den {{date}}',
      enterCardTitle: 'Angiv kortets overskrift...',
      enterCodeFromApp: 'Indtast den 6-cifrede kode fra din autentificeringsapp.',
      enterDescription: 'Angiv beskrivelsen...',
      enterFilename: 'Angiv filnavn',
      enterListTitle: 'Angiv listens overskrift...',
      enterPasswordToContinue: 'Bekræft din nuværende adgangskode for at fortsætte.',
      enterTaskDescription: 'Angiv opgavens beskrivelse...',
      enterTotpOrRecoveryCode:
        'Indtast den 6-cifrede kode fra din autentificeringsapp eller en af dine gendannelseskoder (xxxxx-xxxxx).',
      events: 'Begivenheder',
      ...
      invalidTotpCode: 'Ugyldig TOTP- eller gendannelseskode',
      kanban: 'Kanban',
      labels: 'Labels',
      language: 'Sprog',
      ...
      noTrustedDevices: 'Ingen betroede enheder.',
      ...
      openBoardActions: 'Åbn tavlehandlinger',
      openBoard_title: 'Åbn tavle',
      openCardActions: 'Åbn korthandlinger',
      openListActions: 'Åbn listehandlinger',
      openNotifications: 'Åbn notifikationer',
      openProjectActions: 'Åbn projekthandlinger',
      openProjectSettings: 'Åbn projektindstillinger',
      optional_inline: 'valgfri',
      orEnterSecretManually: 'Eller indtast denne hemmelige nøgle manuelt:',
      ...
      private: 'Privat',
      proFeatureDashboard: '✨ Ét dashboard på tværs af alle projekter',
      proFeatureExport: '✨ Kort som PDF til din rapportering',
      proFeatureMobile: '✨ PLANKA på mobil og tablet',
      proFeatureSso: '✨ Log på med virksomhedens brugerkatalog (SSO)',
      proFeatureThemes: '✨ Fem temaer og din egen accentfarve',
      proFeatureTimeline: '✨ Tidslinje: et helt år på én akse',
      proTrialSelfHosted: '✨ Prøv PLANKA Pro i 30 dage på din egen server',
      project: 'Kanban',
      projectNotFound_title: 'Projekt ikke fundet',
      projectOwner: 'Projektejer',
      recoveryCodesExhausted:
        'Alle gendannelseskoder er blevet brugt. Generer et nyt sæt, så du har en reserve, hvis du mister adgangen til din autentificeringsapp.',
      recoveryCodesIntro:
        'Opbevar disse koder et sikkert sted — hver kode kan bruges én gang, hvis du mister adgangen til din autentificeringsapp.',
      recoveryCodesLow_one:
        'Kun {{count}} gendannelseskode tilbage. Overvej at generere nye snart.',
      recoveryCodesLow_other:
        'Kun {{count}} gendannelseskoder tilbage. Overvej at generere nye snart.',
      referenceDataAndKnowledgeStorage: 'Reference data og vidensopbevaring.',
      regenerateApiKey_title: 'Regenerer API-nøgle',
      regenerateRecoveryCodes_title: 'Regenerer gendannelseskoder',
      regenerateRecoveryCodesIntro:
        'Når du genererer nye koder, bliver alle eksisterende gendannelseskoder ugyldige.',
      ...
      reset2fa_title: 'Nulstil 2FA',
      reset2faWarning:
        'Nulstilling af 2FA logger brugeren ud af alle sessioner og fjerner brugerens TOTP-opsætning. Brugeren skal sætte den op igen ved næste login.',
      role: 'Rolle',
      saveTheseCodes_title: 'Gem disse gendannelseskoder',
      saveThisKeyItWillNotBeShownAgain: 'Gem denne nøgle — den vises ikke igen!',
      scanQrCodeWithApp:
        'Scan denne QR-kode med en autentificeringsapp som Google Authenticator eller Authy.',
      ...
      showHiddenProjects: 'Vis skjulte projekter',
      ...
      title: 'Overskrift',
      totpCode: 'TOTP-kode',
      totpOrRecoveryCode: 'TOTP- eller gendannelseskode',
      trash: 'Papirkurv',
      trashHasBeenSuccessfullyEmptied: 'Papirkurven er blevet tømt.',
      trustedDevices_title: 'Betroede browsere',
      trustedDevicesHint:
        'Browsere, der er markeret som betroede, springer den anden faktor over i 30 dage. Tilbagekald dem, du ikke længere genkender.',
      turnOffRecentCardHighlighting: 'Slå fremhævelse af nylige kort fra',
      twoFactor_enabled: 'To-faktor-autentificering er aktiveret.',
      twoFactor_intro:
        'Tilføj et ekstra sikkerhedslag til din konto med en tidsbaseret engangskode fra en autentificeringsapp.',
    ...
    action: {
      ...
      disable2fa: 'Deaktivér 2FA',
      disableEditMode: 'Deaktivér redigeringstilstand',
      ...
      emptyTrash_title: 'Tøm papirkurv',
      enable2fa: 'Aktivér 2FA',
      enableEditMode: 'Aktivér redigeringstilstand',
      filterByCurrentUser: 'Filtrer efter nuværende bruger',
      goBack: 'Gå tilbage',
      hideHiddenProjects: 'Skjul skjulte projekter',
      hideProjectList: 'Skjul projektliste',
      import: 'Importer',
      join: 'Deltag',
      leave: 'Forlad',
      ...
      regenerateRecoveryCodes: 'Regenerer gendannelseskoder',
      remove: 'Fjern',
      ...
      showLess: 'Vis mindre',
      showMore: 'Vis mere',
      showProjectList: 'Vis projektliste',
      sortList_title: 'Sortér liste',
      start: 'Start',
      stayLoggedIn: 'Forbliv logget på',
      stop: 'Stop',
      subscribe: 'Abonnér',
      switchToGridProjectsView: 'Vis projekter som gitter',
      switchToGridView: 'Skift til gittervisning',
      switchToGroupedProjectsView: 'Vis projekter grupperet',
      switchToKanbanView: 'Skift til kanbanvisning',
