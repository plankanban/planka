...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Bildirim servisi ekle',
      ...
      autoLogout_10m: '10 dakika sonra',
      autoLogout_12h: '12 saat sonra',
      autoLogout_2m: '2 dakika sonra',
      autoLogout_30m: '30 dakika sonra',
      autoLogout_5m: '5 dakika sonra',
      autoLogout_never: 'Asla',
      autoLogoutWarning_body:
        'Hareketsizlik nedeniyle {{seconds}} sn içinde oturumunuz kapatılacak.',
      autoLogoutWarning_title: 'Oturumunuz yakında kapatılacak',
      ...
      color: 'renk',
      comments: 'Yorumlar',
      confirmCodesSaved: 'Bu kodları güvenli bir yere kaydettim.',
      ...
      proFeatureDashboard: '✨ Tüm projeleriniz için tek bir gösterge paneli',
      proFeatureExport: '✨ Raporlarınız için kartları PDF olarak dışa aktarın',
      proFeatureMobile: '✨ Telefon ve tabletlerde PLANKA',
      proFeatureSso: '✨ Şirket dizininizle oturum açın (SSO)',
      proFeatureThemes: '✨ Beş tema ve kendi vurgu renginiz',
      proFeatureTimeline: '✨ Zaman çizelgesi: bir yılın tamamı tek bir eksende',
      proTrialSelfHosted: "✨ PLANKA Pro'yu kendi sunucunuzda 30 gün deneyin",
      dismissProBannerFor30Days: '30 gün için kapat',
      customerPanel_title: 'Müşteri paneli',
      dangerZone_title: 'Tehlikeli bölge',
      disable2fa_title: 'İki faktörlü kimlik doğrulamayı devre dışı bırak',
      disable2faWarning:
        'Mevcut şifrenizi ve bir TOTP kodunu onaylamanız gerekecek. Mevcut oturumlar açık kalır.',
      enable2fa_title: 'İki faktörlü kimlik doğrulamayı etkinleştir',
      enabledOn: '{{date}} tarihinde etkinleştirildi',
      enterCodeFromApp: 'Kimlik doğrulayıcı uygulamanızdaki 6 haneli kodu girin.',
      enterPasswordToContinue: 'Devam etmek için mevcut şifrenizi onaylayın.',
      enterTotpOrRecoveryCode:
        'Kimlik doğrulayıcı uygulamanızdaki 6 haneli kodu veya kurtarma kodlarınızdan birini (xxxxx-xxxxx) girin.',
      expires: 'Sona erme',
      invalidTotpCode: 'Geçersiz TOTP veya kurtarma kodu',
      lastUsed: 'Son kullanım',
      never: 'Hiç',
      noTrustedDevices: 'Güvenilir cihaz yok.',
      orEnterSecretManually: 'Veya bu gizli anahtarı elle girin:',
      recoveryCodesExhausted:
        'Tüm kurtarma kodları kullanıldı. Kimlik doğrulayıcı uygulamanıza erişiminizi kaybetmeniz durumunda yedeğinizin olması için yeni bir set oluşturun.',
      recoveryCodesIntro:
        'Bu kodları güvenli bir yerde saklayın — kimlik doğrulayıcı uygulamanıza erişiminizi kaybederseniz her biri bir kez kullanılabilir.',
      recoveryCodesLow_one:
        'Yalnızca {{count}} kurtarma kodu kaldı. Yakında yeniden oluşturmayı düşünün.',
      recoveryCodesLow_other:
        'Yalnızca {{count}} kurtarma kodu kaldı. Yakında yeniden oluşturmayı düşünün.',
      regenerateRecoveryCodes_title: 'Kurtarma kodlarını yeniden oluştur',
      regenerateRecoveryCodesIntro:
        'Yeni kodlar oluşturmak mevcut tüm kurtarma kodlarını geçersiz kılar.',
      reset2fa_title: "2FA'yı sıfırla",
      reset2faWarning:
        "2FA sıfırlandığında kullanıcının tüm oturumları kapatılır ve TOTP kurulumu kaldırılır. Kullanıcının bir sonraki girişinde 2FA'yı yeniden kurması gerekir.",
      saveTheseCodes_title: 'Bu kurtarma kodlarını kaydedin',
      scanQrCodeWithApp:
        'Bu QR kodunu Google Authenticator veya Authy gibi bir kimlik doğrulayıcı uygulamayla tarayın.',
      security_title: 'Güvenlik',
      totpCode: 'TOTP kodu',
      totpOrRecoveryCode: 'TOTP veya kurtarma kodu',
      trustedDevices_title: 'Güvenilir tarayıcılar',
      trustedDevicesHint:
        'Güvenilir olarak işaretlenen tarayıcılar 30 gün boyunca ikinci faktörü atlar. Artık tanımadıklarınızı iptal edin.',
      twoFactor_enabled: 'İki faktörlü kimlik doğrulama etkin.',
      twoFactor_intro:
        'Kimlik doğrulayıcı bir uygulamadan alınan zaman tabanlı tek kullanımlık kodla hesabınıza ek bir güvenlik katmanı ekleyin.',
      ...
      openBoardActions: 'Pano işlemlerini aç',
      openBoard_title: 'Açık pano',
      openCardActions: 'Kart işlemlerini aç',
      openListActions: 'Liste işlemlerini aç',
      openNotifications: 'Bildirimleri aç',
      openProjectActions: 'Proje işlemlerini aç',
      openProjectSettings: 'Proje ayarlarını aç',
      ...
      showHiddenProjects: 'Gizli projeleri göster',
    ...
    action: {
      ...
      disableEditMode: 'Düzenleme modunu kapat',
      ...
      enableEditMode: 'Düzenleme modunu aç',
      filterByCurrentUser: 'Mevcut kullanıcıya göre filtrele',
      goBack: 'Geri dön',
      hideHiddenProjects: 'Gizli projeleri gizle',
      hideProjectList: 'Proje listesini gizle',
      import: 'İçe aktar',
      join: 'Katıl',
      leave: 'Ayrıl',
      ...
      returnToProjects: 'Projelere dön',
      revoke: 'İptal et',
      save: 'Kaydet',
      ...
      showProjectList: 'Proje listesini göster',
      sortList_title: 'Listeyi sırala',
      start: 'başlat',
      stayLoggedIn: 'Oturumu açık tut',
      stop: 'dur',
      subscribe: 'Abone ol',
      switchToGridProjectsView: 'Projeleri ızgara olarak göster',
      switchToGridView: 'Izgara görünümüne geç',
      switchToGroupedProjectsView: 'Projeleri gruplanmış olarak göster',
      switchToKanbanView: 'Kanban görünümüne geç',
