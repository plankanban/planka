...
export default {
  ...
  translation: {
    common: {
      ...
      addNotificationService_title: 'Aggiungi servizio di notifica',
      ...
      autoLogout_10m: 'Dopo 10 minuti',
      autoLogout_12h: 'Dopo 12 ore',
      autoLogout_2m: 'Dopo 2 minuti',
      autoLogout_30m: 'Dopo 30 minuti',
      autoLogout_5m: 'Dopo 5 minuti',
      autoLogout_never: 'Mai',
      autoLogoutWarning_body: 'Verrai disconnesso tra {{seconds}}s per inattività.',
      autoLogoutWarning_title: 'Stai per essere disconnesso',
      background: 'Sfondo',
      ...
      color: 'Colore',
      comments: 'Commenti',
      confirmCodesSaved: 'Ho salvato questi codici in un luogo sicuro.',
      ...
      proFeatureDashboard: "✨ Un'unica dashboard per tutti i progetti",
      proFeatureExport: '✨ Schede in PDF per i tuoi report',
      proFeatureMobile: '✨ PLANKA su smartphone e tablet',
      proFeatureSso: '✨ Accedi con la directory aziendale (SSO)',
      proFeatureThemes: '✨ Cinque temi e il tuo colore di accento',
      proFeatureTimeline: '✨ Timeline: un anno intero su un solo asse',
      proTrialSelfHosted: '✨ Prova PLANKA Pro per 30 giorni sul tuo server',
      dismissProBannerFor30Days: 'Chiudi per 30 giorni',
      customerPanel_title: 'Pannello cliente',
      dangerZone_title: 'Zona pericolosa',
      disable2fa_title: 'Disattiva autenticazione a due fattori',
      disable2faWarning:
        'Dovrai confermare la tua password attuale e un codice TOTP. Le sessioni esistenti restano connesse.',
      enable2fa_title: 'Attiva autenticazione a due fattori',
      enabledOn: 'Attivata il {{date}}',
      enterCodeFromApp: 'Inserisci il codice a 6 cifre dalla tua app di autenticazione.',
      enterPasswordToContinue: 'Conferma la tua password attuale per continuare.',
      enterTotpOrRecoveryCode:
        'Inserisci il codice a 6 cifre dalla tua app di autenticazione, oppure uno dei tuoi codici di recupero (xxxxx-xxxxx).',
      expires: 'Scadenza',
      invalidTotpCode: 'Codice TOTP o di recupero non valido',
      lastUsed: 'Ultimo utilizzo',
      never: 'Mai',
      noTrustedDevices: 'Nessun dispositivo attendibile.',
      orEnterSecretManually: 'Oppure inserisci manualmente questa chiave segreta:',
      recoveryCodesExhausted:
        "Tutti i codici di recupero sono stati utilizzati. Rigenerane di nuovi per avere un'alternativa se perdi l'accesso alla tua app di autenticazione.",
      recoveryCodesIntro:
        "Conserva questi codici in un luogo sicuro — ognuno può essere usato una sola volta se perdi l'accesso alla tua app di autenticazione.",
      recoveryCodesLow_one:
        'Rimane solo {{count}} codice di recupero. Valuta di rigenerarli presto.',
      recoveryCodesLow_many:
        'Rimangono solo {{count}} codici di recupero. Valuta di rigenerarli presto.',
      recoveryCodesLow_other:
        'Rimangono solo {{count}} codici di recupero. Valuta di rigenerarli presto.',
      regenerateRecoveryCodes_title: 'Rigenera codici di recupero',
      regenerateRecoveryCodesIntro:
        'La generazione di nuovi codici invaliderà tutti i codici di recupero esistenti.',
      reset2fa_title: 'Reimposta 2FA',
      reset2faWarning:
        "La reimpostazione della 2FA disconnette l'utente da tutte le sessioni e rimuove la sua configurazione TOTP. Dovrà configurarla di nuovo al prossimo accesso.",
      saveTheseCodes_title: 'Salva questi codici di recupero',
      scanQrCodeWithApp:
        "Scansiona questo codice QR con un'app di autenticazione come Google Authenticator o Authy.",
      security_title: 'Sicurezza',
      totpCode: 'Codice TOTP',
      totpOrRecoveryCode: 'Codice TOTP o di recupero',
      trustedDevices_title: 'Browser attendibili',
      trustedDevicesHint:
        'I browser contrassegnati come attendibili saltano il secondo fattore per 30 giorni. Revoca quelli che non riconosci più.',
      twoFactor_enabled: "L'autenticazione a due fattori è attiva.",
      twoFactor_intro:
        "Aggiungi un ulteriore livello di sicurezza al tuo account utilizzando un codice monouso a tempo generato da un'app di autenticazione.",
      ...
      openBoardActions: 'Apri azioni bacheca',
      openBoard_title: 'Bacheca aperta',
      openCardActions: 'Apri azioni scheda',
      openListActions: 'Apri azioni lista',
      openNotifications: 'Apri notifiche',
      openProjectActions: 'Apri azioni progetto',
      ...
      showHiddenProjects: 'Mostra progetti nascosti',
    ...
    action: {
      ...
      disableEditMode: 'Disattiva modalità di modifica',
      ...
      enableEditMode: 'Attiva modalità di modifica',
      filterByCurrentUser: 'Filtra per utente corrente',
      goBack: 'Indietro',
      hideHiddenProjects: 'Nascondi progetti nascosti',
      hideProjectList: 'Nascondi lista dei progetti',
      import: 'Importa',
      join: 'Entra',
      leave: 'Abbandona',
      ...
      showProjectList: 'Mostra lista dei progetti',
      sortList_title: 'Ordina',
      start: 'Inizio',
      stayLoggedIn: 'Rimani connesso',
      stop: 'Interrompi',
      subscribe: 'Iscriviti',
      switchToGridProjectsView: 'Mostra progetti a griglia',
      switchToGridView: 'Passa alla vista a griglia',
      switchToGroupedProjectsView: 'Mostra progetti raggruppati',
      switchToKanbanView: 'Passa alla vista Kanban',
      switchToListView: 'Passa alla vista a lista',
