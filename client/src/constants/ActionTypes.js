...
export default {
  ...
  /* Card relations */
  CARD_RELATION_CREATE: 'CARD_RELATION_CREATE',
  CARD_RELATION_CREATE__SUCCESS: 'CARD_RELATION_CREATE__SUCCESS',
  CARD_RELATION_CREATE__FAILURE: 'CARD_RELATION_CREATE__FAILURE',
  CARD_RELATION_CREATE_HANDLE: 'CARD_RELATION_CREATE_HANDLE',
  CARD_RELATION_DELETE: 'CARD_RELATION_DELETE',
  CARD_RELATION_DELETE__SUCCESS: 'CARD_RELATION_DELETE__SUCCESS',
  CARD_RELATION_DELETE__FAILURE: 'CARD_RELATION_DELETE__FAILURE',
  CARD_RELATION_DELETE_HANDLE: 'CARD_RELATION_DELETE_HANDLE',
  RELATION_KIND_TO_FILTER_IN_CURRENT_BOARD_ADD: 'RELATION_KIND_TO_FILTER_IN_CURRENT_BOARD_ADD',
  RELATION_KIND_FROM_FILTER_IN_CURRENT_BOARD_REMOVE:
    'RELATION_KIND_FROM_FILTER_IN_CURRENT_BOARD_REMOVE',
