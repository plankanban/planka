...
export default {
  ...
  CURRENT_PROJECT_EXPORT_TEMPLATE: `${PREFIX}/CURRENT_PROJECT_EXPORT_TEMPLATE`,
  CURRENT_PROJECT_EXPORT_FULL: `${PREFIX}/CURRENT_PROJECT_EXPORT_FULL`,
  PROJECT_EXPORT_HANDLE: `${PREFIX}/PROJECT_EXPORT_HANDLE`,
