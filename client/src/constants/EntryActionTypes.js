...
export default {
  ...
  /* Card relations */
  CARD_RELATION_CREATE: `${PREFIX}/CARD_RELATION_CREATE`,
  CARD_RELATION_IN_CURRENT_CARD_CREATE: `${PREFIX}/CARD_RELATION_IN_CURRENT_CARD_CREATE`,
  CARD_RELATION_CREATE_HANDLE: `${PREFIX}/CARD_RELATION_CREATE_HANDLE`,
  CARD_RELATION_DELETE: `${PREFIX}/CARD_RELATION_DELETE`,
  CARD_RELATION_IN_CURRENT_CARD_DELETE: `${PREFIX}/CARD_RELATION_IN_CURRENT_CARD_DELETE`,
  CARD_RELATION_DELETE_HANDLE: `${PREFIX}/CARD_RELATION_DELETE_HANDLE`,
  RELATION_KIND_TO_FILTER_IN_CURRENT_BOARD_ADD: `${PREFIX}/RELATION_KIND_TO_FILTER_IN_CURRENT_BOARD_ADD`,
  RELATION_KIND_FROM_FILTER_IN_CURRENT_BOARD_REMOVE: `${PREFIX}/RELATION_KIND_FROM_FILTER_IN_CURRENT_BOARD_REMOVE`,
